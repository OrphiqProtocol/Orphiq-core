...
- Bump CometBFT to 0.37.15-Orphiq1
...
- go/worker/keymanager/churp: Add metrics
  ...
  - `Orphiq_worker_keymanager_churp_handoff_number`
...
- keymanager/src/runtime: Support master secret rotations
  ...
  - `Orphiq_worker_keymanager_enclave_master_secret_proposal_generation_number`
...
- go/control: Improve node registration status clarity
  ...
  Three new fields have been added to the `Orphiq-node control status`'s output
...
- go/keymanager/api: Add signed encrypted master secret
  ([#5199](https://github.com/Orphiqprotocol/Orphiq-core/issues/5199))

- runtime: Always use host node ID when verifying freshness with RAK
  ([#5201](https://github.com/Orphiqprotocol/Orphiq-core/issues/5201))

  This avoids an initial scan over all the nodes in the registry.

- runtime: Use a limited multi-threaded Tokio runtime in SGX
  ([#5214](https://github.com/Orphiqprotocol/Orphiq-core/issues/5214))

- keymanager: Support policies in unsafe builds
  ([#5215](https://github.com/Orphiqprotocol/Orphiq-core/issues/5215))
...
- go/worker/keymanager: Optimize enclave initialization
  ([#5218](https://github.com/Orphiqprotocol/Orphiq-core/issues/5218))
...
- runtime: Refactor Tokio runtime constructor
  ([#5220](https://github.com/Orphiqprotocol/Orphiq-core/issues/5220))

- docker: Switch to ghcr.io for container registry
  ([#5224](https://github.com/Orphiqprotocol/Orphiq-core/issues/5224))
...
- go/consensus/tendermint: Implement `{Prepare,Process}Proposal`
  ([#5285](https://github.com/Orphiqprotocol/Orphiq-core/issues/5285))
...
- go/Orphiq-test-runner: Build key manager runtime with trust root
  ([#5307](https://github.com/Orphiqprotocol/Orphiq-core/issues/5307))
...
- tests/upgrade: Test master secrets
  ([#5325](https://github.com/Orphiqprotocol/Orphiq-core/issues/5325))

  The upgrade scenario was enhanced to test runtime and key manager upgrades,
  trust roots and master secret rotations.

- Bump Go to 1.21.0
  ([#5030](https://github.com/Orphiqprotocol/Orphiq-core/issues/5030),
   [#5228](https://github.com/Orphiqprotocol/Orphiq-core/issues/5228),
   [#5356](https://github.com/Orphiqprotocol/Orphiq-core/issues/5356))

- go: Remove timecache replace directive in `go.mod` file
  ([#5272](https://github.com/Orphiqprotocol/Orphiq-core/issues/5272))
...
- go: Remove flatbuffers replace directive in `go.mod` file
  ([#5273](https://github.com/Orphiqprotocol/Orphiq-core/issues/5273))
...
- go: Ignore CVE-2022-44797 until tendermint uses newer btcd
  ([#5024](https://github.com/Orphiqprotocol/Orphiq-core/issues/5024))

- go: Bump golang.org/x/net to 0.13.0
  ([#5095](https://github.com/Orphiqprotocol/Orphiq-core/issues/5095),
   [#5337](https://github.com/Orphiqprotocol/Orphiq-core/issues/5337))

- go: Bump go-libp2p-pubsub to 0.9.1
  ([#5180](https://github.com/Orphiqprotocol/Orphiq-core/issues/5180),
   [#5195](https://github.com/Orphiqprotocol/Orphiq-core/issues/5195))

- go: Bump go-libp2p to 0.30.0
  ([#5026](https://github.com/Orphiqprotocol/Orphiq-core/issues/5026),
   [#5087](https://github.com/Orphiqprotocol/Orphiq-core/issues/5087),
   [#5180](https://github.com/Orphiqprotocol/Orphiq-core/issues/5180),
   [#5297](https://github.com/Orphiqprotocol/Orphiq-core/issues/5297),
   [#5338](https://github.com/Orphiqprotocol/Orphiq-core/issues/5338),
   [#5339](https://github.com/Orphiqprotocol/Orphiq-core/issues/5339),
   [#5355](https://github.com/Orphiqprotocol/Orphiq-core/issues/5355))

- runtime: Bump serde_json to 1.0.87
  ([#5031](https://github.com/Orphiqprotocol/Orphiq-core/issues/5031))
...
- runtime: Bump Orphiq-cbor to 0.5.1
  ([#5035](https://github.com/Orphiqprotocol/Orphiq-core/issues/5035))

- runtime: Bump tendermint-rs to 0.30.0
  ([#5037](https://github.com/Orphiqprotocol/Orphiq-core/issues/5037),
   [#5106](https://github.com/Orphiqprotocol/Orphiq-core/issues/5106),
   [#5190](https://github.com/Orphiqprotocol/Orphiq-core/issues/5190),
   [#5234](https://github.com/Orphiqprotocol/Orphiq-core/issues/5234))

- runtime: Bump tokio to 1.29.1
  ([#5120](https://github.com/Orphiqprotocol/Orphiq-core/issues/5120),
   [#5330](https://github.com/Orphiqprotocol/Orphiq-core/issues/5330))

- runtime: Bump tempfile to 3.4.0
  ([#5213](https://github.com/Orphiqprotocol/Orphiq-core/issues/5213))

- runtime: Bump ed25519-dalek to 2.0.0
  ([#5351](https://github.com/Orphiqprotocol/Orphiq-core/issues/5351))
...
- docker: Bump base image to Ubuntu 22.04
  ([#5141](https://github.com/Orphiqprotocol/Orphiq-core/issues/5141))

- docker: Bump cargo-tarpaulin to 0.25.0
  ([#5191](https://github.com/Orphiqprotocol/Orphiq-core/issues/5191))
...
- go/staking/grpc: rename misnamed GovernanceDeposits method
  ([#4652](https://github.com/Orphiqprotocol/Orphiq-core/issues/4652))

- go/runtime: Mandate the use of runtime schedule control
  ([#4665](https://github.com/Orphiqprotocol/Orphiq-core/issues/4665))
...
- Add support for PCS attestation
  ([#4806](https://github.com/Orphiqprotocol/Orphiq-core/issues/4806),
   [#4789](https://github.com/Orphiqprotocol/Orphiq-core/issues/4789),
   [#4720](https://github.com/Orphiqprotocol/Orphiq-core/issues/4720),
   [#4752](https://github.com/Orphiqprotocol/Orphiq-core/issues/4752))

- go/governance: Add change parameters proposal
  ([#4938](https://github.com/Orphiqprotocol/Orphiq-core/issues/4938))
...
- Add archive mode support
  ([#4539](https://github.com/Orphiqprotocol/Orphiq-core/issues/4539))
...
- go/control: Show the debug option statuses in the control output
  ([#4634](https://github.com/Orphiqprotocol/Orphiq-core/issues/4634))

- runtime: Make persistent transaction check state configurable
  ([#4640](https://github.com/Orphiqprotocol/Orphiq-core/issues/4640))
...
- go/control/status: Add fields for quick overview of node status
  ([#4669](https://github.com/Orphiqprotocol/Orphiq-core/issues/4669))

- go/worker/storage: Make checkpoint sync peer selection smarter
  ([#4671](https://github.com/Orphiqprotocol/Orphiq-core/issues/4671))

- runtime: verify epoch in dispatcher using consensus verifier
  ([#4677](https://github.com/Orphiqprotocol/Orphiq-core/issues/4677))

- go/worker/compute: Ensure trust root is verified before registering
  ([#4678](https://github.com/Orphiqprotocol/Orphiq-core/issues/4678))

- go/worker/compute: Start batch resolution early for backup worker
  ([#4679](https://github.com/Orphiqprotocol/Orphiq-core/issues/4679))

- go/runtime/txpool: Add roothash incoming messages' data as transactions
  ([#4681](https://github.com/Orphiqprotocol/Orphiq-core/issues/4681))
...
- go/worker/registration: add node status metrics
  ([#4686](https://github.com/Orphiqprotocol/Orphiq-core/issues/4686))

- runtime: Enable dispatcher to verify state integrity for queries
  ([#4694](https://github.com/Orphiqprotocol/Orphiq-core/issues/4694),
   [#4830](https://github.com/Orphiqprotocol/Orphiq-core/issues/4830),
   [#4904](https://github.com/Orphiqprotocol/Orphiq-core/issues/4904))

- go/worker/common/p2p: Add support for persistent and blocked peers
  ([#4713](https://github.com/Orphiqprotocol/Orphiq-core/issues/4713))

- go/worker/common: Properly handle dynamic key manager configuration
  ([#4715](https://github.com/Orphiqprotocol/Orphiq-core/issues/4715))
...
- go/runtime/txpool: Add txpool metric for rejected runtime transactions
  ([#4724](https://github.com/Orphiqprotocol/Orphiq-core/issues/4724))

- runtime: Verify RAK in consensus state when serving requests
  ([#4741](https://github.com/Orphiqprotocol/Orphiq-core/issues/4741))

- runtime: Add support for reporting EnclaveRPC peer feedback
  ([#4757](https://github.com/Orphiqprotocol/Orphiq-core/issues/4757))
...
- archive-mode: disable runtime P2P if archive mode is used
  ([#4775](https://github.com/Orphiqprotocol/Orphiq-core/issues/4775))

- go/consensus/tendermint: Add `consensus.tendermint.halt_height`
  ([#4793](https://github.com/Orphiqprotocol/Orphiq-core/issues/4793))
...
- net-runner: Add --fixture.default.runtime.version flag
  ([#4813](https://github.com/Orphiqprotocol/Orphiq-core/issues/4813))

- go/Orphiq-node: allow km to have private peers
  ([#4821](https://github.com/Orphiqprotocol/Orphiq-core/issues/4821))

- go/runtime/registry: allow client nodes to run sgx runtimes
  ([#4832](https://github.com/Orphiqprotocol/Orphiq-core/issues/4832))
...
- go/worker/keymanager: Add key manager worker metrics
  ([#4877](https://github.com/Orphiqprotocol/Orphiq-core/issues/4877))

  The following metrics were added:

  - Orphiq_worker_keymanager_compute_runtime_count

  - Orphiq_worker_keymanager_enclave_rpc_count

  - Orphiq_worker_keymanager_policy_update_count

- go/control/status: Add key manager worker status to node status
  ([#4883](https://github.com/Orphiqprotocol/Orphiq-core/issues/4883))

- keymanager: Add support for ephemeral keys
  ([#4888](https://github.com/Orphiqprotocol/Orphiq-core/issues/4888))

- Orphiq-net-runner: Set default max_allowances, increase test account balance
  ([#4902](https://github.com/Orphiqprotocol/Orphiq-core/issues/4902))

  The max_allowances staking setting in the default Orphiq-net-runner fixture has
  ...
  Orphiq-net-runner was increased from 100 tokens to 1 million. This makes the
...
- runtime/consensus/verifier: Support trust root consensus layer upgrades
  ([#4903](https://github.com/Orphiqprotocol/Orphiq-core/issues/4903))

- runtime: Support consensus event queries
  ([#4904](https://github.com/Orphiqprotocol/Orphiq-core/issues/4904))

- keymanager: Validate latest trust root height in key manager requests
  ([#4910](https://github.com/Orphiqprotocol/Orphiq-core/issues/4910))

- registry: Add ProveFreshness consensus layer transaction
  ([#4916](https://github.com/Orphiqprotocol/Orphiq-core/issues/4916))
...
- runtime: Add client node TEE freshness verification
  ([#4922](https://github.com/Orphiqprotocol/Orphiq-core/issues/4922))

- keymanager: Verify that policy was published in the consensus layer
  ([#4925](https://github.com/Orphiqprotocol/Orphiq-core/issues/4925))

- Bind TEE attestations to nodes and enforce freshness
  ([#4926](https://github.com/Orphiqprotocol/Orphiq-core/issues/4926))

- go/genesis: Cache computed genesis document hash
  ([#4919](https://github.com/Orphiqprotocol/Orphiq-core/issues/4919))

- go/Orphiq-node/cmd: unsafe-reset preserve local storage by default
  ([#4700](https://github.com/Orphiqprotocol/Orphiq-core/issues/4700))

- go/Orphiq-node/cmd: unsafe-reset check datadir validity
  ([#4702](https://github.com/Orphiqprotocol/Orphiq-core/issues/4702))

- runtime: Emit runtime logs as Orphiq-node logs
  ([#4709](https://github.com/Orphiqprotocol/Orphiq-core/issues/4709),
   [#4924](https://github.com/Orphiqprotocol/Orphiq-core/issues/4924))
...
- go/worker/compute: Always include resolved transactions
  ([#4633](https://github.com/Orphiqprotocol/Orphiq-core/issues/4633))

- go/runtime/txpool: Fix crash on early access
  ([#4638](https://github.com/Orphiqprotocol/Orphiq-core/issues/4638))

- go/worker/compute: Improve proposed transaction handling
  ([#4640](https://github.com/Orphiqprotocol/Orphiq-core/issues/4640))

- go/runtime/host: Always emit StoppedEvent on stop
  ([#4647](https://github.com/Orphiqprotocol/Orphiq-core/issues/4647))
...
- go/worker/common/p2p: Make sure P2P stops before service cleanup runs
  ([#4650](https://github.com/Orphiqprotocol/Orphiq-core/issues/4650))

  Otherwise this may result in a crash during shutdown when P2P requests are
  processed while database is already closed.

- go/Orphiq-node/cmd/control: Fix runtime-stats arg
  ([#4659](https://github.com/Orphiqprotocol/Orphiq-core/issues/4659))

- Fix waiting for deregister event on `RequestShutdown`
  ([#4662](https://github.com/Orphiqprotocol/Orphiq-core/issues/4662))

- go/worker/compute: Only advertise active version for TEE runtimes
  ([#4683](https://github.com/Orphiqprotocol/Orphiq-core/issues/4683))
...
- go/runtime/host/sandbox: Properly handle clone3 in seccomp policy
  ([#4687](https://github.com/Orphiqprotocol/Orphiq-core/issues/4687),
   [#4861](https://github.com/Orphiqprotocol/Orphiq-core/issues/4861),
   [#4867](https://github.com/Orphiqprotocol/Orphiq-core/issues/4867))
...
- go/runtime/config: report error if SGX loader required but not configured
  ([#4710](https://github.com/Orphiqprotocol/Orphiq-core/issues/4710))

- go/worker/keymanager: Fix crash on capability TEE updates
  ([#4725](https://github.com/Orphiqprotocol/Orphiq-core/issues/4725))

- go/worker/registration: Only register once epoch is known
  ([#4726](https://github.com/Orphiqprotocol/Orphiq-core/issues/4726))

- go/runtime/registry: Refresh key manager policy on runtime changes
  ([#4729](https://github.com/Orphiqprotocol/Orphiq-core/issues/4729))
...
- go/runtime/config: fix SGX provisioner check for runtimes without SGX
  ([#4734](https://github.com/Orphiqprotocol/Orphiq-core/issues/4734))
...
- go/common/quantity: Avoid side-effects on errors
  ([#4790](https://github.com/Orphiqprotocol/Orphiq-core/issues/4790))

- net-runner: Fix regression introduced in #4564
  ([#4808](https://github.com/Orphiqprotocol/Orphiq-core/issues/4808))

  Fix the missing Deployments field when Orphiq-net-runner generating the genesis
  state and no key manager is provided.

- go/registry/api/runtime: ensure no nil deployments in ValidateDeployments
  ([#4822](https://github.com/Orphiqprotocol/Orphiq-core/issues/4822))
...
- go/consensus/tendermint: Make sure DBs are only closed during cleanup
  ([#4823](https://github.com/Orphiqprotocol/Orphiq-core/issues/4823))

- go/Orphiq-node/cmd/genesis: Fix reading of height argument when dumping state
  ([#4892](https://github.com/Orphiqprotocol/Orphiq-core/issues/4892))
...
- go/runtime/txpool: Add block propagation delay before tx publish
  ([#4959](https://github.com/Orphiqprotocol/Orphiq-core/issues/4959))

- go/runtime: Fix configuring the SGX-based provisioner
  ([#4960](https://github.com/Orphiqprotocol/Orphiq-core/issues/4960))
...
- go/worker/compute: Only process keymanager client initialization once
  ([#4962](https://github.com/Orphiqprotocol/Orphiq-core/issues/4962))

### Documentation Improvements

- Document `gcc-multilib` dependency for Ubuntu/Debian systems
  ([#4475](https://github.com/Orphiqprotocol/Orphiq-core/issues/4475))

  It is needed for building `Orphiq-core-runtime`.

- doc: Replace community slack links with discord
  ([#4751](https://github.com/Orphiqprotocol/Orphiq-core/issues/4751))

- doc: Migrate ADRs to Orphiqprotocol/adrs repo
  ([#4770](https://github.com/Orphiqprotocol/Orphiq-core/issues/4770))

### Internal Changes

- Orphiq-net-runner: support configuring runtime state and state root
  ([#4843](https://github.com/Orphiqprotocol/Orphiq-core/issues/4843))

- go/worker/common/p2p/rpc: Add support for per-call peer limits
  ([#4671](https://github.com/Orphiqprotocol/Orphiq-core/issues/4671))

- docker: Add Orphiqprotocol/aesmd Docker image
  ([#4690](https://github.com/Orphiqprotocol/Orphiq-core/issues/4690))

- runtime: Bump tendermint-rs, x509-parser and oid-registry
  ([#4706](https://github.com/Orphiqprotocol/Orphiq-core/issues/4706))

- ci: Build OpenSSL statically for Orphiq Core releases
  ([#4707](https://github.com/Orphiqprotocol/Orphiq-core/issues/4707))

  This makes sure that Orphiq-core-loader is more portable between
  distributions.

- go/common/sgx/aesm: Add support for newer methods
  ([#4711](https://github.com/Orphiqprotocol/Orphiq-core/issues/4711))

- rust-toolchain: Migrate to TOML version of rust-toolchain
  ([#4727](https://github.com/Orphiqprotocol/Orphiq-core/issues/4727))

- go/common/node/address: use custom type instead of `net.TCPAddr`
  ([#4744](https://github.com/Orphiqprotocol/Orphiq-core/issues/4744))

- go: Bump go-libp2p to 0.23.2
  ([#4765](https://github.com/Orphiqprotocol/Orphiq-core/issues/4765),
   [#4782](https://github.com/Orphiqprotocol/Orphiq-core/issues/4782),
   [#4906](https://github.com/Orphiqprotocol/Orphiq-core/issues/4906),
   [#4944](https://github.com/Orphiqprotocol/Orphiq-core/issues/4944))

- go: Bump viper to 1.12.0
  ([#4766](https://github.com/Orphiqprotocol/Orphiq-core/issues/4766))

- go/Orphiq-test-runner/fixture: support configuring runtime messages
  ([#4769](https://github.com/Orphiqprotocol/Orphiq-core/issues/4769))

- runtime: Bump Orphiq-cbor to 0.5.0
  ([#4784](https://github.com/Orphiqprotocol/Orphiq-core/issues/4784),
   [#4835](https://github.com/Orphiqprotocol/Orphiq-core/issues/4835))

- go/Orphiq-test-runner/byzantine: Add primary+backup liveness test
  ([#4799](https://github.com/Orphiqprotocol/Orphiq-core/issues/4799))

- Bump Go to 1.18.3
  ([#4820](https://github.com/Orphiqprotocol/Orphiq-core/issues/4820))

- go/runtime/host: Make sure runtime-reported version matches bundle
  ([#4825](https://github.com/Orphiqprotocol/Orphiq-core/issues/4825))

- go: remove synced storage wrapper
  ([#4837](https://github.com/Orphiqprotocol/Orphiq-core/issues/4837))

- go/common/sgx/sigstruct: Add support for offline signing
  ([#4844](https://github.com/Orphiqprotocol/Orphiq-core/issues/4844))

- go: Drop go-fuzz in favor of Go 1.18 fuzzing support
  ([#4875](https://github.com/Orphiqprotocol/Orphiq-core/issues/4875))

- keymanager-client: Skip policy when Orphiq_UNSAFE_SKIP_KM_POLICY is set
  ([#4878](https://github.com/Orphiqprotocol/Orphiq-core/issues/4878))

- go/common/grpc: advancedtls options moved to IdentityOptions
  ([#4886](https://github.com/Orphiqprotocol/Orphiq-core/issues/4886))

- runtime: Refactor dispatcher initializer and expose consensus_verifier
  ([#4893](https://github.com/Orphiqprotocol/Orphiq-core/issues/4893))
...
- Bump Rust toolchain to 2022-08-22
  ([#4896](https://github.com/Orphiqprotocol/Orphiq-core/issues/4896))

- runtime: Add epoch_state query and EPOCH_INVALID constant
  ([#4897](https://github.com/Orphiqprotocol/Orphiq-core/issues/4897))

- go: Bump Tendermint to v0.34.21
  ([#4899](https://github.com/Orphiqprotocol/Orphiq-core/issues/4899))

- go: Add consensus transaction prioritization
  ([#4911](https://github.com/Orphiqprotocol/Orphiq-core/issues/4911))

- go/worker/keymanager: Use common runtime host handler
  ([#4926](https://github.com/Orphiqprotocol/Orphiq-core/issues/4926))

- Bump tokio to 1.20.x
  ([#4928](https://github.com/Orphiqprotocol/Orphiq-core/issues/4928))

- keymanager: Refactor and reorganize runtime-related crates
  ([#4930](https://github.com/Orphiqprotocol/Orphiq-core/issues/4930))

- runtime/consensus/tendermint/verifier: Refactor verifier
  ([#4934](https://github.com/Orphiqprotocol/Orphiq-core/issues/4934))

- runtime: Add current sender sequence number to CheckTxMeta
  ([#4956](https://github.com/Orphiqprotocol/Orphiq-core/issues/4956))

- runtime-loader: Remove unused ELF loader
  ([#4969](https://github.com/Orphiqprotocol/Orphiq-core/issues/4969))

- mkvs/proof: Make sure that all entries in the proof have been used
  ([#4973](https://github.com/Orphiqprotocol/Orphiq-core/issues/4973))
...
Previous versions allowed running Orphiq Node (i.e. the `Orphiq-node` binary) as
root (effective user ID of 0).
As of this version, this is no longer allowed and attempting to run the
`Orphiq-node` process as the root user will now terminate immediately on startup.

### Removals and Breaking Changes

- governance: Allow unregistered nodes in votes
  ([#4607](https://github.com/Orphiqprotocol/Orphiq-core/issues/4607))
...
- go/consensus/tendermint: Record node liveness successes
  ([#4615](https://github.com/Orphiqprotocol/Orphiq-core/issues/4615))

- scheduler: Improve runtime committee election fairness
  ([#4623](https://github.com/Orphiqprotocol/Orphiq-core/issues/4623))
...
- go/Orphiq-node/cmd/node: Do not allow running Orphiq Node as root
  ([#4464](https://github.com/Orphiqprotocol/Orphiq-core/issues/4464))

  Nothing in Orphiq Node will ever require elevated privileges.  Attempting
  to run the `Orphiq-node` process as the root user will now terminate
...
- go/worker/storage: Storage checkpoints are now disabled by default
  ([#4561](https://github.com/Orphiqprotocol/Orphiq-core/issues/4561))
...
- go/Orphiq-node/cmd/stake: Allow querying historical account info
  ([#4416](https://github.com/Orphiqprotocol/Orphiq-core/issues/4416),
   [#4620](https://github.com/Orphiqprotocol/Orphiq-core/issues/4620))

  The `Orphiq-node stake account info` CLI command now accepts `--height` flag
...
- go/Orphiq-node/cmd/debug/bundle: Add `info` command
  ([#4546](https://github.com/Orphiqprotocol/Orphiq-core/issues/4546))

  Add `Orphiq-node debug bundle info` CLI command for inspecting runtime bundles.

- Randomize storage checkpoints wall-clock interval
  ([#4561](https://github.com/Orphiqprotocol/Orphiq-core/issues/4561))

- go/worker/registration: Add a random re-registration delay
  ([#4574](https://github.com/Orphiqprotocol/Orphiq-core/issues/4574))

- go/consensus/tendermint: Bump default max number of inbound peers
  ([#4576](https://github.com/Orphiqprotocol/Orphiq-core/issues/4576))

- go/worker: Add txsync protocol
  ([#4579](https://github.com/Orphiqprotocol/Orphiq-core/issues/4579))

  No longer clear tx pool on epoch transitions. Add the txsync protocol for
  syncing transaction between nodes.

- go/Orphiq-node/cmd/control: Add `clear-deregister` command
  ([#4580](https://github.com/Orphiqprotocol/Orphiq-core/issues/4580))
  ...
  `Orphiq-node control clear-deregister` CLI command that will do so.

- runtime/host/sgx: Log the advisory URLs on attestation failure
  ([#4582](https://github.com/Orphiqprotocol/Orphiq-core/issues/4582))

- go/Orphiq-node/cmd: Preserve MKVS database by default in `unsafe-reset` command
  ([#4588](https://github.com/Orphiqprotocol/Orphiq-core/issues/4588))
  ...
  making that the default for `Orphiq-node unsafe-reset`.
...
- go/signature: Apply options on registered contexts
  ([#4591](https://github.com/Orphiqprotocol/Orphiq-core/issues/4591))

- go/Orphiq-node/cmd/control: Add `runtime-stats` command
  ([#4596](https://github.com/Orphiqprotocol/Orphiq-core/issues/4596))

  The new `Orphiq-node control runtime-stats` CLI command allows querying
  historical runtime statistics.

- Implements liveness and some other useful executor metrics
  ([#4610](https://github.com/Orphiqprotocol/Orphiq-core/issues/4610))

  The following Prometheus metrics were added:

  - `Orphiq_worker_executor_is_worker`
  - `Orphiq_worker_executor_is_backup_worker`
  - `Orphiq_worker_executor_committee_p2p_peers`
  - `Orphiq_worker_executor_liveness_total_rounds`
  - `Orphiq_worker_executor_liveness_live_rounds`
  - `Orphiq_worker_executor_liveness_live_ratio`

  See [metrics documentation] for descriptions of metrics.

  [metrics documentation]: https://docs.Orphiq.io/core/Orphiq-node/metrics

- go/Orphiq-node/cmd: Allow using non local gRPC connections
  ([#4617](https://github.com/Orphiqprotocol/Orphiq-core/issues/4617))

  Require server-side TLS for non unix-socket gRPC connections.

- go/worker/common: Lower default transaction recheck interval
  ([#4618](https://github.com/Orphiqprotocol/Orphiq-core/issues/4618))

### Bug Fixes

- go/common/identity: Save re-generated sentry client TLS certificate
  ([#4382](https://github.com/Orphiqprotocol/Orphiq-core/issues/4382))

  Sentry client TLS certificate is always re-generated from the private key when
  the Orphiq Node starts.
...
- go/common/identity: Save re-generated node's persistent TLS certificate
  ...
  private key when the Orphiq Node starts.
...
- go/worker/common: Don't crash if current descriptor is not ready
  ([#4534](https://github.com/Orphiqprotocol/Orphiq-core/issues/4534))

- go/worker/beacon: Don't submit VRF proofs if registration disabled
  ([#4536](https://github.com/Orphiqprotocol/Orphiq-core/issues/4536))

- go/runtime/host/multi: Release lock before calling into runtime
  ([#4538](https://github.com/Orphiqprotocol/Orphiq-core/issues/4538))

- go/worker/common: Watch for all deployment updates when suspended
  ([#4541](https://github.com/Orphiqprotocol/Orphiq-core/issues/4541))

- go/worker/common: Properly refresh liveness statistics
  ([#4543](https://github.com/Orphiqprotocol/Orphiq-core/issues/4543))

- go/worker/storage: Only attempt checkpoint sync on initial startup
  ([#4544](https://github.com/Orphiqprotocol/Orphiq-core/issues/4544))

- go/Orphiq-node/cmd/ias: Refresh runtimes on every epoch
  ([#4548](https://github.com/Orphiqprotocol/Orphiq-core/issues/4548))

- go/worker/common: Propagate CheckTx errors
  ([#4551](https://github.com/Orphiqprotocol/Orphiq-core/issues/4551))

- consensus/sanity-checks: Skip suspended runtimes for computing stake claims
  ([#4556](https://github.com/Orphiqprotocol/Orphiq-core/issues/4556))

- runtime: Commit check transaction results for subsequent batches
  ([#4557](https://github.com/Orphiqprotocol/Orphiq-core/issues/4557))

- go/runtime/txpool: Abort runtime in case it times out during checks
  ([#4563](https://github.com/Orphiqprotocol/Orphiq-core/issues/4563))

- Orphiq-net-runner: Fix fixtures without a keymanager
  ([#4564](https://github.com/Orphiqprotocol/Orphiq-core/issues/4564))
...
- go/registry: Fix invalid sanity check
  ([#4585](https://github.com/Orphiqprotocol/Orphiq-core/issues/4585))

- go/worker/registration: Fix shutdown if registration never succeeded
  ([#4595](https://github.com/Orphiqprotocol/Orphiq-core/issues/4595))
...
- go/registry: Fix node stake claim sanity check with suspended runtimes
  ([#4603](https://github.com/Orphiqprotocol/Orphiq-core/issues/4603))

### Internal Changes

- go: The libp2p logs are now emitted via Orphiq Node's logging system
  ([#4531](https://github.com/Orphiqprotocol/Orphiq-core/issues/4531))

- go/runtime/bundle: Verify SGX signature if present
  ([#4542](https://github.com/Orphiqprotocol/Orphiq-core/issues/4542))

- go: Bump libp2p to 0.18.0
  ([#4562](https://github.com/Orphiqprotocol/Orphiq-core/issues/4562),
   [#4568](https://github.com/Orphiqprotocol/Orphiq-core/issues/4568),
   [#4578](https://github.com/Orphiqprotocol/Orphiq-core/issues/4578))

- go/worker/storage: Remove separate storage sync status store
  ([#4565](https://github.com/Orphiqprotocol/Orphiq-core/issues/4565))
...
- ci: Show dirtiness after regenerating protos
  ([#4598](https://github.com/Orphiqprotocol/Orphiq-core/issues/4598))

- go/common/crypto/signature: Improve the batch verification API
  ([#4602](https://github.com/Orphiqprotocol/Orphiq-core/issues/4602))

- go/upgrade: Add empty upgrade handler
  ([#4616](https://github.com/Orphiqprotocol/Orphiq-core/issues/4616))

- go: Bump github.com/opencontainers/image-spec to 1.0.2
  ([#4629](https://github.com/Orphiqprotocol/Orphiq-core/issues/4629))
...
- go/registry/api: Lower minimum runtime round timeout
  ([#4090](https://github.com/Orphiqprotocol/Orphiq-core/issues/4090))
...
- go/common/node: Add `SoftwareVersion` to the node descriptor
  ([#4212](https://github.com/Orphiqprotocol/Orphiq-core/issues/4212))
...
- go/beacon: Add support for, and switch to VRF based elections defined in
  [ADR 0010]
  ([#4248](https://github.com/Orphiqprotocol/Orphiq-core/issues/4248))

  [ADR 0010]:
    https://github.com/Orphiqprotocol/adrs/blob/main/0010-vrf-elections.md

- Remove runtime genesis state parameter
  ([#4308](https://github.com/Orphiqprotocol/Orphiq-core/issues/4308))

  Runtimes are now expected to initialize genesis state on their own when
  processing the first block. Existing runtimes that use the Orphiq SDK already
  do that.
...
- go/governance: Replace `Quorum`/`Threshold` parameters with `StakeThreshold`
  ([#4309](https://github.com/Orphiqprotocol/Orphiq-core/issues/4309))
  ...
  The `Orphiq-node debug fix-genesis` command's conversion logic will convert the
  existing parameters to a stake threshold of 68%.

- go/roothash: Persist last round results in consensus state
  ([#4316](https://github.com/Orphiqprotocol/Orphiq-core/issues/4316))
...
- go/roothash: Add incoming runtime messages as defined in [ADR 0011]
  ([#4415](https://github.com/Orphiqprotocol/Orphiq-core/issues/4415))

  <!-- markdownlint-disable line-length -->
  [ADR 0011]:
    https://github.com/Orphiqprotocol/adrs/blob/main/0011-incoming-runtime-messages.md
  <!-- markdownlint-enable line-length -->

- go/staking: `DebondEndTime` is added to the `DebondingStartEscrowEvent`
  ([#4437](https://github.com/Orphiqprotocol/Orphiq-core/issues/4437))
...
- go/staking: Add minimum transfer amount
  ([#4456](https://github.com/Orphiqprotocol/Orphiq-core/issues/4456))
...
- go/worker/storage: Transition storage sync to P2P
  ([#4459](https://github.com/Orphiqprotocol/Orphiq-core/issues/4459))

- go/staking: Add minimum transact balance
  ([#4461](https://github.com/Orphiqprotocol/Orphiq-core/issues/4461))
...
- consensus: Base64 encode all tendermint event values
  ([#4465](https://github.com/Orphiqprotocol/Orphiq-core/issues/4465))
  ...
  Although Orphiq Core still uses Tendermint 0.34, events are updated now to
  avoid breaking changes later.

- Add support for node suspension due to runtime liveness failures
  ([#4470](https://github.com/Orphiqprotocol/Orphiq-core/issues/4470))

- go/runtime/txpool: Refactor runtime scheduling queue
  ([#4477](https://github.com/Orphiqprotocol/Orphiq-core/issues/4477))
...
- go/common/cbor: Bump decoding limits
  ([#4478](https://github.com/Orphiqprotocol/Orphiq-core/issues/4478))

- go/worker/keymanager: Transition keymanager protocol to P2P
  ([#4490](https://github.com/Orphiqprotocol/Orphiq-core/issues/4490))

- go/worker/storage: Transition public storage RPC to P2P
  ([#4500](https://github.com/Orphiqprotocol/Orphiq-core/issues/4500))

### Configuration Changes

- runtime: Change `Orphiq_STRICT_AVR_VERIFY` to `Orphiq_UNSAFE_LAX_AVR_VERIFY`
  ([#4055](https://github.com/Orphiqprotocol/Orphiq-core/issues/4055))
  ...
  status), unless `Orphiq_UNSAFE_LAX_AVR_VERIFY` is set.
...
- Introducing the runtime mode
  ([#4308](https://github.com/Orphiqprotocol/Orphiq-core/issues/4308),
   [#4520](https://github.com/Orphiqprotocol/Orphiq-core/issues/4520))
...
- Switch to unified runtime bundles
  ([#4469](https://github.com/Orphiqprotocol/Orphiq-core/issues/4469))
...
- go/Orphiq-node/cmd/consensus: Add `next_block_state` command
  ([#4241](https://github.com/Orphiqprotocol/Orphiq-core/issues/4241))

  This adds the `Orphiq-node consensus next_block_state` CLI command that shows
...
- go/runtime/client: Add missing `GetTransactionsWithResults` method
  ([#4295](https://github.com/Orphiqprotocol/Orphiq-core/issues/4295))

- go/common: Use entire error as error message
  ([#4298](https://github.com/Orphiqprotocol/Orphiq-core/issues/4298))

- go/runtime/host/sgx: Autodetect SGX device name
  ([#4333](https://github.com/Orphiqprotocol/Orphiq-core/issues/4333))

- go/runtime/client: Add last retained round query
  ([#4334](https://github.com/Orphiqprotocol/Orphiq-core/issues/4334))
...
- go/runtime/scheduling: Allow a higher priority tx even if queue is full
  ([#4431](https://github.com/Orphiqprotocol/Orphiq-core/issues/4431))

- go/worker/common: Report locally supported runtime host versions
  ([#4436](https://github.com/Orphiqprotocol/Orphiq-core/issues/4436))

- Add support for runtime schedule control
  ([#4438](https://github.com/Orphiqprotocol/Orphiq-core/issues/4438))
...
- Add support for runtime message results as defined in [ADR 0012]
  ([#4443](https://github.com/Orphiqprotocol/Orphiq-core/issues/4443))

  <!-- markdownlint-disable line-length -->
  [ADR 0012]:
    https://github.com/Orphiqprotocol/adrs/blob/main/0012-runtime-message-results.md
  <!-- markdownlint-enable line-length -->

- go/runtime: Downtime-less runtime updates
  ([#4449](https://github.com/Orphiqprotocol/Orphiq-core/issues/4449))
...
- go/Orphiq-node: Implement unified runtime bundles
  ([#4469](https://github.com/Orphiqprotocol/Orphiq-core/issues/4469))
...
- tendermint: Bump to version 0.34.15-Orphiq1
  ([#4481](https://github.com/Orphiqprotocol/Orphiq-core/issues/4481))

- go/worker/common: Report liveness statistics in runtime status
  ([#4524](https://github.com/Orphiqprotocol/Orphiq-core/issues/4524))
...
- go/common/identity: Don't forget to refresh TLS certificate
  ([#4289](https://github.com/Orphiqprotocol/Orphiq-core/issues/4289))

- go/worker/storage: Fix potential memory leak through context
  ([#4290](https://github.com/Orphiqprotocol/Orphiq-core/issues/4290))

- go/storage/api: Handle context cancellation in `receiveWriteLogIterator`
  ([#4292](https://github.com/Orphiqprotocol/Orphiq-core/issues/4292))

- go/worker/storage: Configure `GetDiff` timeout
  ([#4296](https://github.com/Orphiqprotocol/Orphiq-core/issues/4296))

- go: Make sure correct namespace/hash text serialization is used
  ([#4303](https://github.com/Orphiqprotocol/Orphiq-core/issues/4303))

- go/worker/storage: Handle state sync before runtime is operational
  ([#4311](https://github.com/Orphiqprotocol/Orphiq-core/issues/4311))
...
- go/Orphiq-node/cmd: Add missing namespace to `LatestStateRoot`
  ([#4317](https://github.com/Orphiqprotocol/Orphiq-core/issues/4317))

- go/worker/compute: Handle round results at genesis
  ([#4317](https://github.com/Orphiqprotocol/Orphiq-core/issues/4317))

- go/consensus/tendermint: Only reset executor pool after emitting block
  ([#4323](https://github.com/Orphiqprotocol/Orphiq-core/issues/4323))
...
- go/runtime/client: `SubmitTxNoWait` should propagate `CheckTx` error
  ([#4328](https://github.com/Orphiqprotocol/Orphiq-core/issues/4328))

- go/staking: Fix incorrect non-existence check
  ([#4340](https://github.com/Orphiqprotocol/Orphiq-core/issues/4340))

- go/runtime/history: Limit batch size when pruning rounds
  ([#4345](https://github.com/Orphiqprotocol/Orphiq-core/issues/4345))

- go/consensus/tendermint/roothash: Only index the correct runtime
  ([#4351](https://github.com/Orphiqprotocol/Orphiq-core/issues/4351))
...
- Orphiq-node: Make Semver parsing less strict
  ([#4366](https://github.com/Orphiqprotocol/Orphiq-core/issues/4366))
  ...
  [#4343]: https://github.com/Orphiqprotocol/Orphiq-core/issues/4343

- go/storage/mkvs: Don't fail sanity check for equal roots
  ([#4381](https://github.com/Orphiqprotocol/Orphiq-core/issues/4381))
...
- runtime: Propagate panics during transaction/local RPC/policy dispatch
  ([#4386](https://github.com/Orphiqprotocol/Orphiq-core/issues/4386))
...
- go/runtime/client: Take storage into account in `GetLastRetainedBlock`
  ([#4387](https://github.com/Orphiqprotocol/Orphiq-core/issues/4387))

- go/worker/storage: Checkpoint correct round on consensus checkpoint
  ([#4387](https://github.com/Orphiqprotocol/Orphiq-core/issues/4387))

- go/storage/client: Catch `GetDiff` errors early
  ([#4397](https://github.com/Orphiqprotocol/Orphiq-core/issues/4397))

- go/worker/storage: Limit number of rounds to fetch before applying them
  ([#4403](https://github.com/Orphiqprotocol/Orphiq-core/issues/4403))
...
- go/storage/api: Make metrics wrapper return proper types
  ([#4411](https://github.com/Orphiqprotocol/Orphiq-core/issues/4411))
...
- go/runtime/transaction: Return transactions in batch order when queried
  ([#4429](https://github.com/Orphiqprotocol/Orphiq-core/issues/4429))
...
- runtime: Switch to the upstream jsonrpc package
  ([#4439](https://github.com/Orphiqprotocol/Orphiq-core/issues/4439))

- go/runtime/scheduling: Attempt to continue scheduling
  ([#4453](https://github.com/Orphiqprotocol/Orphiq-core/issues/4453))

- runtime: Fix `registry.Roothash` serialization
  ([#4460](https://github.com/Orphiqprotocol/Orphiq-core/issues/4460))
...
- Allow launching enclaves with `SW_HARDENING_NEEDED` quote status
  ([#4491](https://github.com/Orphiqprotocol/Orphiq-core/issues/4491))
...
- [ADR 0011]: Incoming Runtime Messages
  ([#4327](https://github.com/Orphiqprotocol/Orphiq-core/issues/4327))

- [ADR 0012]: Runtime Message Results
  ([#4392](https://github.com/Orphiqprotocol/Orphiq-core/issues/4392))

- Migrate [Orphiq Core Docs] to Docusaurus
  ([#4501](https://github.com/Orphiqprotocol/Orphiq-core/issues/4501))

  [Orphiq Core Docs]: https://docs.Orphiq.io/core/

### Internal Changes

- Use typed attributes in all consensus services
  ([#4034](https://github.com/Orphiqprotocol/Orphiq-core/issues/4034))
...
- go: Bump fxamacker/cbor to 2.3.0
  ([#3986](https://github.com/Orphiqprotocol/Orphiq-core/issues/3986))
...
- Setup rust code lints
  ([#4170](https://github.com/Orphiqprotocol/Orphiq-core/issues/4170))
...
- runtime: Bump tendermint-rs to 0.23.1
  ([#4365](https://github.com/Orphiqprotocol/Orphiq-core/issues/4365))

- Bump Go to 1.17.3 and Rust to nightly-2021-11-04
  ([#4375](https://github.com/Orphiqprotocol/Orphiq-core/issues/4375))

- tests/workload/runtime: Wait for 3rd epoch for compute nodes to be up
  ([#4395](https://github.com/Orphiqprotocol/Orphiq-core/issues/4395))
...
- go/consensus/tendermint/api: Add transaction context
  ([#4426](https://github.com/Orphiqprotocol/Orphiq-core/issues/4426))
...
- go/common/dynlib: Embed dynlib
  ([#4513](https://github.com/Orphiqprotocol/Orphiq-core/issues/4513))
...
- runtime: Remove `runtime`, `tags` and `messages` context fields
  ([#3572](https://github.com/Orphiqprotocol/Orphiq-core/issues/3572))
...
- go/runtime: Remove tag indexer
  ([#3888](https://github.com/Orphiqprotocol/Orphiq-core/issues/3888))
...
- runtime: Verify consensus layer state by using a light client
  ([#3952](https://github.com/Orphiqprotocol/Orphiq-core/issues/3952))

- go/runtime/client: Remove deprecated `GetTxs` method
  ([#3983](https://github.com/Orphiqprotocol/Orphiq-core/issues/3983))

  The `GetTxs` method has been deprecated and removed. Users should migrate
  to use `GetTransactions` instead.

- Orphiq-node: Remove opentracing and jaeger support
  ([#4011](https://github.com/Orphiqprotocol/Orphiq-core/issues/4011))
...
- go/ias-proxy: remove the debug `use genesis` option
  ([#4098](https://github.com/Orphiqprotocol/Orphiq-core/issues/4098))

- go/Orphiq-node: Prevent startup when file descriptor limit is too low
  ([#4192](https://github.com/Orphiqprotocol/Orphiq-core/issues/4192))
...
- runtime: Deprecate `transaction::MethodDispatcher`
  ([#4198](https://github.com/Orphiqprotocol/Orphiq-core/issues/4198))

- runtime: Deprecate the old `MethodDispatcher` related types
  ([#4201](https://github.com/Orphiqprotocol/Orphiq-core/issues/4201))

- go/roothash: Remove `GetLatestBlock` from `BlockHistory` interface
  ([#4217](https://github.com/Orphiqprotocol/Orphiq-core/issues/4217))
...
- go/scheduler: Remove `debug_static_validators` consensus parameter
  ([#4222](https://github.com/Orphiqprotocol/Orphiq-core/issues/4222))

  The option was only used in unit tests and required some special handling.

- go/runtime: Remove obsolete transaction types
  ([#4228](https://github.com/Orphiqprotocol/Orphiq-core/issues/4228))
...
- runtime: Add `MaxMessages` to `CheckTxBatch` and `Query`
  ([#4231](https://github.com/Orphiqprotocol/Orphiq-core/issues/4231))
...
- keymanager-api-common: Implement `Zeroize` for secret types
  ([#4242](https://github.com/Orphiqprotocol/Orphiq-core/issues/4242))

- Remove EnclaveRPC client gRPC interface
  ([#4244](https://github.com/Orphiqprotocol/Orphiq-core/issues/4244))
...
- runtime: Make storage cache capacity configurable
  ([#4264](https://github.com/Orphiqprotocol/Orphiq-core/issues/4264))
...
- runtime: Make dispatcher core async
  ([#4273](https://github.com/Orphiqprotocol/Orphiq-core/issues/4273))
...
- runtime: Refactor protocol type, expose via `transaction::Context`
  ([#4276](https://github.com/Orphiqprotocol/Orphiq-core/issues/4276))

- go/common: Change `Namespace`'s text (un)marshaling to use the hex form
  ([#4279](https://github.com/Orphiqprotocol/Orphiq-core/issues/4279))
...
- runtime: Pass query arguments as arbitrary bytes
  ([#4280](https://github.com/Orphiqprotocol/Orphiq-core/issues/4280))
...
- go/consensus/api: Change `Block`'s `Hash` field type to the common `Hash` type
  ([#4281](https://github.com/Orphiqprotocol/Orphiq-core/issues/4281))
  ...
  <!-- markdownlint-disable line-length -->
  [common `Hash` type]:
    https://pkg.go.dev/github.com/Orphiqprotocol/Orphiq-core/go/common/crypto/hash#Hash
  <!-- markdownlint-enable line-length -->
...
- go/worker/common/p2p: Add flags controlling libp2p validator concurrency
  ([#4025](https://github.com/Orphiqprotocol/Orphiq-core/issues/4025))
...
- badger/migration: `badger.migrate.num_go_routines` flag
  ([#4037](https://github.com/Orphiqprotocol/Orphiq-core/issues/4037),
   [#4041](https://github.com/Orphiqprotocol/Orphiq-core/issues/4041))
...
- go/worker/executor: Batch runtime `CheckTx` transactions
  ([#2548](https://github.com/Orphiqprotocol/Orphiq-core/issues/2548))

- go/staking: Add `DebondingStartEscrowEvent`
  ([#4014](https://github.com/Orphiqprotocol/Orphiq-core/issues/4014))

  This makes it easier to reason about the debonded amounts, both in shares and
  in base units.

- go/Orphiq-net-runner: Allow setting runtime provisioner
  ([#4024](https://github.com/Orphiqprotocol/Orphiq-core/issues/4024))

  On systems that do not support Bubblewrap, the runtime provisioner can be
  set to `unconfined`.

- go/Orphiq-net-runner: Allow running without a key manager
  ([#4024](https://github.com/Orphiqprotocol/Orphiq-core/issues/4024))
...
- Orphiq-net-runner: Support setting custom node arguments in fixtures
  ([#4025](https://github.com/Orphiqprotocol/Orphiq-core/issues/4025))

- Build `Orphiq-node` with `jemalloc` tag (used by BadgerDB)
  ([#4040](https://github.com/Orphiqprotocol/Orphiq-core/issues/4040),
   [#4046](https://github.com/Orphiqprotocol/Orphiq-core/issues/4046))
  ...
  To build `Orphiq-node` without `jemalloc` requirement, set the
  `Orphiq_BADGER_NO_JEMALLOC="1"` environment variable before invoking the
  `Makefile`.
...
- upgrade/migrations: Add max allowances upgrade handler
  ([#4064](https://github.com/Orphiqprotocol/Orphiq-core/issues/4064))
...
- go/common/errors: Expose runtime query error details to clients
  ([#4067](https://github.com/Orphiqprotocol/Orphiq-core/issues/4067))

- go/worker/storage: Synchronize checkpoints with consensus layer
  ([#4080](https://github.com/Orphiqprotocol/Orphiq-core/issues/4080))

- runtime/client: Add `SubmitTx` variant that includes metadata
  ([#4162](https://github.com/Orphiqprotocol/Orphiq-core/issues/4162))

- go/registry/api: Add its own body type to `MethodDeregisterEntity`
  ([#4177](https://github.com/Orphiqprotocol/Orphiq-core/issues/4177))

- upgrade/migrations: Add `consensus-params-update-2021-08` upgrade handler
  ([#4180](https://github.com/Orphiqprotocol/Orphiq-core/issues/4180))

- go/roothash/api/block: Use custom `Timestamp` type for block's header
  ([#4183](https://github.com/Orphiqprotocol/Orphiq-core/issues/4183))

  This enables prettier Orphiq Node's `control status` CLI command's output
  for runtimes' `latest_time` field and matches the format of consensus'
  `latest_time` field.

- go/roothash/api: Add `ConsensusParameters` method
  ([#4187](https://github.com/Orphiqprotocol/Orphiq-core/issues/4187))

- go/consensus/tendermint: Request state refresh on consensus init
  ([#4237](https://github.com/Orphiqprotocol/Orphiq-core/issues/4237))
...
- go/common/node: Add custom text (un)marshaler for `RolesMask` type
  ([#4243](https://github.com/Orphiqprotocol/Orphiq-core/issues/4243))
...
- go/common/entity: Use pretty-printed JSON when saving entity to file
  ([#4266](https://github.com/Orphiqprotocol/Orphiq-core/issues/4266))

- go/Orphiq-node/cmd: Use pretty-printed variant when outputting JSON
  ([#4266](https://github.com/Orphiqprotocol/Orphiq-core/issues/4266))
...
- go/Orphiq-net-runner: Always honor `fixture.default.setup_runtimes`
  ([#4009](https://github.com/Orphiqprotocol/Orphiq-core/issues/4009))

- go/common/badger: Fix v2->v3 migration for managed mode
  ([#4010](https://github.com/Orphiqprotocol/Orphiq-core/issues/4010))
...
- go/consensus/tendermint/apps/staking: Fix emitted reward events
  ([#4033](https://github.com/Orphiqprotocol/Orphiq-core/issues/4033))

- badger/migration: Keep only last version when migrating non-managed DB
  ([#4037](https://github.com/Orphiqprotocol/Orphiq-core/issues/4037))

  Even though Orphiq Core always configures non-managed badger databases to keep
...
- go/runtime/host/sandbox: Prevent restart storm after 10 minutes
  ([#4059](https://github.com/Orphiqprotocol/Orphiq-core/issues/4059))

- go/consensus/tendermint: Fix last retained version query
  ([#4060](https://github.com/Orphiqprotocol/Orphiq-core/issues/4060))
...
- go/worker/executor: Do not route local storage applies via gRPC
  ([#4061](https://github.com/Orphiqprotocol/Orphiq-core/issues/4061))

- go/upgrade/api: Validate upgrade migration handler name on registration
  ([#4065](https://github.com/Orphiqprotocol/Orphiq-core/issues/4065))

- go/worker/storage: Add missing timeout for operations
  ([#4072](https://github.com/Orphiqprotocol/Orphiq-core/issues/4072))
...
- ias/proxy/client: Make `GetSigRL` not panic if IAS proxy not configured
  ([#4081](https://github.com/Orphiqprotocol/Orphiq-core/issues/4081))

- go/worker/executor: Skip proposer timeout if batch was received
  ([#4083](https://github.com/Orphiqprotocol/Orphiq-core/issues/4083))

- go/consensus/tendermint: Handle validator fetching error in `GetStatus()`
  ([#4085](https://github.com/Orphiqprotocol/Orphiq-core/issues/4085))

- go/worker/common: Always use naked local storage
  ([#4093](https://github.com/Orphiqprotocol/Orphiq-core/issues/4093))
...
- go/storage/mkvs/checkpoint: Determine next offset correctly
  ([#4096](https://github.com/Orphiqprotocol/Orphiq-core/issues/4096))

- go/worker/compute: Replicate input batch locally
  ([#4107](https://github.com/Orphiqprotocol/Orphiq-core/issues/4107))
...
- go/consensus/tendermint: Correctly propagate errors
  ([#4110](https://github.com/Orphiqprotocol/Orphiq-core/issues/4110))
...
- go/runtime/host/sandbox: Add deadline to Bubblewrap pipes
  ([#4111](https://github.com/Orphiqprotocol/Orphiq-core/issues/4111))
...
- go/runtime/client: Fail `SubmitTx` early for unsupported runtimes
  ([#4202](https://github.com/Orphiqprotocol/Orphiq-core/issues/4202))
...
- go/runtime: Fix ignored round in runtime `Query`
  ([#4210](https://github.com/Orphiqprotocol/Orphiq-core/issues/4210))

- go/runtime/client: Wait for hosted runtime provisioning
  ([#4214](https://github.com/Orphiqprotocol/Orphiq-core/issues/4214))
...
- go/common/identity: Refresh sentry TLS certificates
  ([#4239](https://github.com/Orphiqprotocol/Orphiq-core/issues/4239))
...
- go/upgrade: EnsureCompatible should only check consensus
  ([#4267](https://github.com/Orphiqprotocol/Orphiq-core/issues/4267))

- go/common/grpc: Configure max message size on the client
  ([#4268](https://github.com/Orphiqprotocol/Orphiq-core/issues/4268))

### Documentation Improvements

- Update example output of `Orphiq-node control status` CLI command
  ([#4281](https://github.com/Orphiqprotocol/Orphiq-core/issues/4281))

### Internal Changes

- go: Bump github.com/dgraph-io/badger/v3 from 3.2011.1 to 3.2103.1
  ([#4003](https://github.com/Orphiqprotocol/Orphiq-core/issues/4003),
   [#4127](https://github.com/Orphiqprotocol/Orphiq-core/issues/4127))

- go: Bump github.com/prometheus/common from 0.25.0 to 0.28.0
  ([#4007](https://github.com/Orphiqprotocol/Orphiq-core/issues/4007))

- go: Bump github.com/prometheus/client_golang from 1.10.0 to 1.11.0
  ([#4008](https://github.com/Orphiqprotocol/Orphiq-core/issues/4008))

- runtime: Stop using webpki to validate the IAS cert chain
  ([#4021](https://github.com/Orphiqprotocol/Orphiq-core/issues/4021))

- runtime: Do not require `Orphiq_STORAGE_PROTOCOL_SERVER_BINARY`
  ([#4023](https://github.com/Orphiqprotocol/Orphiq-core/issues/4023))

- go: Bump gitlab.com/yawning/dynlib to the latest version
  ([#4026](https://github.com/Orphiqprotocol/Orphiq-core/issues/4026))

- go/Orphiq-node/cmd/debug: Remove the `consim` sub-command
  ([#4030](https://github.com/Orphiqprotocol/Orphiq-core/issues/4030))

- go: Bump github.com/spf13/viper from 1.7.1 to 1.8.0
  ([#4032](https://github.com/Orphiqprotocol/Orphiq-core/issues/4032))
...
- build: Stuff to make CI faster
  ([#4038](https://github.com/Orphiqprotocol/Orphiq-core/issues/4038))

- ci: Fix dirty Git state in the release GitHub Actions workflow
  ([#4050](https://github.com/Orphiqprotocol/Orphiq-core/issues/4050))

- github: Unify jemalloc installation with GoReleaser installation in workflows
  ([#4052](https://github.com/Orphiqprotocol/Orphiq-core/issues/4052))
...
- go/consensus/tendermint/apps/governance: Ensure upgrade is in progress
  ([#4070](https://github.com/Orphiqprotocol/Orphiq-core/issues/4070))
...
- runtime: Bump bech32 to 0.8.1
  ([#4089](https://github.com/Orphiqprotocol/Orphiq-core/issues/4089))

- runtime: Bump tendermint to 0.20.0
  ([#4089](https://github.com/Orphiqprotocol/Orphiq-core/issues/4089))

- ci: Make jemalloc builds reproducible
  ([#4095](https://github.com/Orphiqprotocol/Orphiq-core/issues/4095))

- runtime: Use JSON-RPC for the mkvs interop helper
  ([#4101](https://github.com/Orphiqprotocol/Orphiq-core/issues/4101))

- go/worker/compute: Add runtime abort timeout to avoid blocking forever
  ([#4111](https://github.com/Orphiqprotocol/Orphiq-core/issues/4111))

- go/common/logging: Switch to go-kit/log module
  ([#4117](https://github.com/Orphiqprotocol/Orphiq-core/issues/4117))

  This is the only part of go-kit that we are using so it makes sense to switch
  to the smaller package.

- runtime: Switch from serde-cbor for Orphiq-cbor
  ([#4133](https://github.com/Orphiqprotocol/Orphiq-core/issues/4133),
   [#4278](https://github.com/Orphiqprotocol/Orphiq-core/issues/4278))

- rust: Bump rsa from 0.4.0 to 0.5.0
  ([#4147](https://github.com/Orphiqprotocol/Orphiq-core/issues/4147))

- runtime/simple-keyvalue: Check nonces
  ([#4154](https://github.com/Orphiqprotocol/Orphiq-core/issues/4154))

- storage/checkpoint_sync: Add timeout for fetching checkpoints from nodes
  ([#4155](https://github.com/Orphiqprotocol/Orphiq-core/issues/4155))

- workload/runtime: Ensure correct round for validating events
  ([#4161](https://github.com/Orphiqprotocol/Orphiq-core/issues/4161))

- go/registry/gen_vectors: Stop generating register transactions for v1 entities
  ([#4167](https://github.com/Orphiqprotocol/Orphiq-core/issues/4167))

- rust: Bump x509-parser from 0.9.2 to 0.10.0
  ([#4173](https://github.com/Orphiqprotocol/Orphiq-core/issues/4173))

- rust: Bump intrusive-collections to 0.9.2
  ([#4174](https://github.com/Orphiqprotocol/Orphiq-core/issues/4174))

- go: Update gofumpt to 0.1.1
  ([#4176](https://github.com/Orphiqprotocol/Orphiq-core/issues/4176))

- go/registry/gen_vectors: Add vectors for deregister entity transactions
  ([#4177](https://github.com/Orphiqprotocol/Orphiq-core/issues/4177))

- go/Orphiq-test-runner: Add support for testing upgrade handlers
  ([#4179](https://github.com/Orphiqprotocol/Orphiq-core/issues/4179))

- go: Update golangci-lint to 1.41.1
  ([#4190](https://github.com/Orphiqprotocol/Orphiq-core/issues/4190))

- rust/ci: Bump tarpaulin to 0.18.0
  ([#4197](https://github.com/Orphiqprotocol/Orphiq-core/issues/4197))

- rust: Update crossbeam-deque to 0.7.4/0.8.1
  ([#4209](https://github.com/Orphiqprotocol/Orphiq-core/issues/4209))

- rust: Bump tokio from 1.8.1 to 1.10.1
  ([#4213](https://github.com/Orphiqprotocol/Orphiq-core/issues/4213))

- go/Orphiq-test-runner: Add an E2E test for (un)freezing a slashed validator
  ([#4223](https://github.com/Orphiqprotocol/Orphiq-core/issues/4223))

- Bump Rust toolchain to 2021-08-17
  ([#4235](https://github.com/Orphiqprotocol/Orphiq-core/issues/4235))

- go: Bump github.com/libp2p/go-libp2p to 0.15.0
  ([#4257](https://github.com/Orphiqprotocol/Orphiq-core/issues/4257))

- go: Bump grpc to 1.40.0
  ([#4260](https://github.com/Orphiqprotocol/Orphiq-core/issues/4260))

- go/fixgenesis: Remove the not anymore relevant migration
  ([#4265](https://github.com/Orphiqprotocol/Orphiq-core/issues/4265))

- go/Orphiq-node/cmd/common: Add `PrettyJSONMarshal()` helper
  ([#4266](https://github.com/Orphiqprotocol/Orphiq-core/issues/4266))
...
- rust: Bump zeroize_derive to 1.2.0
  ([#4282](https://github.com/Orphiqprotocol/Orphiq-core/issues/4282))
...
- runtime: add support for transaction priority and weights
  ([#3760](https://github.com/Orphiqprotocol/Orphiq-core/issues/3760))
...
- runtime: Ensure compatible consensus versions
  ([#3823](https://github.com/Orphiqprotocol/Orphiq-core/issues/3823))
...
- runtime: Add support for block tags
  ([#3848](https://github.com/Orphiqprotocol/Orphiq-core/issues/3848))

- runtime: Add epoch to ExecuteTx/CheckTx/Query requests
  ([#3892](https://github.com/Orphiqprotocol/Orphiq-core/issues/3892))

- go/cmd/registry: simplify register runtime command
  ([#3903](https://github.com/Orphiqprotocol/Orphiq-core/issues/3903))
...
- staking: Include share amounts in `AddEscrow` and `ReclaimEscrow` events
  ([#3939](https://github.com/Orphiqprotocol/Orphiq-core/issues/3939))

- Update emitted events when disbursing rewards
  ([#3944](https://github.com/Orphiqprotocol/Orphiq-core/issues/3944))
...
- Change IAS proxy client authentication configuration
  ([#3958](https://github.com/Orphiqprotocol/Orphiq-core/issues/3958))
  ...
  for example: `<pubkey>@ias.Orphiq.dev`.

- go/worker/compute: remove `schedule_check_tx.enabled` flag
  ([#3965](https://github.com/Orphiqprotocol/Orphiq-core/issues/3965))
...
- Bump Badger database to v3
  ([#3859](https://github.com/Orphiqprotocol/Orphiq-core/issues/3859))
...
- runtime: Implement consensus staking layer state accessors
  ([#3564](https://github.com/Orphiqprotocol/Orphiq-core/issues/3564))

- Add support for local runtime-specific configuration
  ([#3776](https://github.com/Orphiqprotocol/Orphiq-core/issues/3776))
...
- go/runtime/client: Add `GetTransactions` method, deprecate `GetTxs`
  ([#3812](https://github.com/Orphiqprotocol/Orphiq-core/issues/3812))
...
- go/roothash/api: Add gRPC service
  ([#3827](https://github.com/Orphiqprotocol/Orphiq-core/issues/3827))

- common/crypto/signature: Use curve25519-voi
  ([#3829](https://github.com/Orphiqprotocol/Orphiq-core/issues/3829))
...
- go/Orphiq-node/cmd/genesis: Display doc's hash and SHA256 checksum with `check`
  ([#3858](https://github.com/Orphiqprotocol/Orphiq-core/issues/3858))

- go/worker/compute: Propose block on runtime genesis
  ([#3894](https://github.com/Orphiqprotocol/Orphiq-core/issues/3894))

- go/Orphiq-node: Add storage namespace rename subcommand
  ([#3908](https://github.com/Orphiqprotocol/Orphiq-core/issues/3908))

- go/Orphiq-net-runner: default fixture support staking genesis
  ([#3914](https://github.com/Orphiqprotocol/Orphiq-core/issues/3914))

- go/Orphiq-net-runner: support multiple runtimes in default fixture
  ([#3914](https://github.com/Orphiqprotocol/Orphiq-core/issues/3914))

- go/common/crypto/sakg: Add [ADR 0008] implementation
  ([#3918](https://github.com/Orphiqprotocol/Orphiq-core/issues/3918))

  <!-- markdownlint-disable line-length -->
  [ADR 0008]:
    https://github.com/Orphiqprotocol/adrs/blob/main/0008-standard-account-key-generation.md
  <!-- markdownlint-enable line-length -->

- go/worker/compute: Propose block on new epoch
  ([#3987](https://github.com/Orphiqprotocol/Orphiq-core/issues/3987))

- go/Orphiq-node/cmd/debug/beacon: Initial import
  ([#3897](https://github.com/Orphiqprotocol/Orphiq-core/issues/3897))
...
- go/Orphiq-node: Dump correct block height on halt
  ([#3755](https://github.com/Orphiqprotocol/Orphiq-core/issues/3755))

- go/storage/mkvs: Skip already pruned nodes in migration
  ([#3857](https://github.com/Orphiqprotocol/Orphiq-core/issues/3857))

- Apply upgrade proposals directly from governance consensus application
  ([#3870](https://github.com/Orphiqprotocol/Orphiq-core/issues/3870))
...
- Runtime workers should wait for history reindex
  ([#3889](https://github.com/Orphiqprotocol/Orphiq-core/issues/3889))
...
- go/consensus/tendermint: Update nonce post-execution during CheckTx
  ([#3896](https://github.com/Orphiqprotocol/Orphiq-core/issues/3896))
...
- worker/storage: Fix heartbeat stall
  ([#3899](https://github.com/Orphiqprotocol/Orphiq-core/issues/3899))

- go/runtime/client: Properly propagate CheckTx error context
  ([#3973](https://github.com/Orphiqprotocol/Orphiq-core/issues/3973))

### Documentation Improvements

- ADR 0008: Standard Account Key Generation
  ([#3656](https://github.com/Orphiqprotocol/Orphiq-core/issues/3656))

- Update [Security] document
  ([#3853](https://github.com/Orphiqprotocol/Orphiq-core/issues/3853))

  [Security]: SECURITY.md

- Note that `RELEASE_BRANCH` variable needs to be exported in [Release Process]
  ([#3891](https://github.com/Orphiqprotocol/Orphiq-core/issues/3891),
   [#3993](https://github.com/Orphiqprotocol/Orphiq-core/issues/3993))

  [Release Process]: docs/release-process.md

- ADR 0009: Ed25519 Signature Verification Semantics
  ([#3925](https://github.com/Orphiqprotocol/Orphiq-core/issues/3925))

- Add missing gRPC services and beacon service
  ([#3991](https://github.com/Orphiqprotocol/Orphiq-core/issues/3991))

### Internal Changes

- go/worker: Make compute and client node use local storage if available
  ([#3251](https://github.com/Orphiqprotocol/Orphiq-core/issues/3251))

- Runtime consensus state interoperability tests
  ([#3833](https://github.com/Orphiqprotocol/Orphiq-core/issues/3833))

- go: bump github.com/hashicorp/go-hclog from 0.15.0 to 0.16.1
  ([#3834](https://github.com/Orphiqprotocol/Orphiq-core/issues/3834),
  [#3927](https://github.com/Orphiqprotocol/Orphiq-core/issues/3927))

- go/storage: Remove unused ForceFinalize RPC call
  ([#3863](https://github.com/Orphiqprotocol/Orphiq-core/issues/3863))

- e2e/runtime: Add test for storage sync after messy/incorrect cleanup
  ([#3863](https://github.com/Orphiqprotocol/Orphiq-core/issues/3863))

- rust: bump tendermint from 0.18.1 to 0.19.0
  ([#3866](https://github.com/Orphiqprotocol/Orphiq-core/issues/3866))

- Build and upload release artifacts on every master/stable merge
  ([#3875](https://github.com/Orphiqprotocol/Orphiq-core/issues/3875))

- go: Ignore jwt-go vulns since we're not using the features
  ([#3877](https://github.com/Orphiqprotocol/Orphiq-core/issues/3877))

- go: bump github.com/hashicorp/go-plugin from 1.4.0 to 1.4.2
  ([#3880](https://github.com/Orphiqprotocol/Orphiq-core/issues/3880))

- Bump Go to 1.16.3
  ([#3886](https://github.com/Orphiqprotocol/Orphiq-core/issues/3886))

- changelog: Automatically add protocol versions table
  ([#3891](https://github.com/Orphiqprotocol/Orphiq-core/issues/3891))

- rust: bump hmac from 0.10.1 to 0.11.0
  ([#3906](https://github.com/Orphiqprotocol/Orphiq-core/issues/3906))

- go: bump github.com/grpc-ecosystem/go-grpc-middleware from 1.2.2 to 1.3.0
  ([#3915](https://github.com/Orphiqprotocol/Orphiq-core/issues/3915))

- go/staking/gen_account_vectors: Add [ADR 0008] test vectors
  ([#3918](https://github.com/Orphiqprotocol/Orphiq-core/issues/3918),
   [#3960](https://github.com/Orphiqprotocol/Orphiq-core/issues/3960))
...
- go: bump github.com/libp2p/go-libp2p from 0.13.0 to 0.14.0
  ([#3928](https://github.com/Orphiqprotocol/Orphiq-core/issues/3928))

- common/crypto/slip-10: Relax the seed-length check
  ([#3945](https://github.com/Orphiqprotocol/Orphiq-core/issues/3945))
...
- runtime/common/crypto/signature: Switch Ed25519 to our consensus flavor
  ([#3946](https://github.com/Orphiqprotocol/Orphiq-core/issues/3946))

- rust: bump curve25519-dalek from 3.0.0 to 3.1.0
  ([#3949](https://github.com/Orphiqprotocol/Orphiq-core/issues/3949))

- runtime: Bump futures/tokio/grpcio
  ([#3950](https://github.com/Orphiqprotocol/Orphiq-core/issues/3950))

- go: bump github.com/prometheus/common from 0.20.0 to 0.25.0
  ([#3951](https://github.com/Orphiqprotocol/Orphiq-core/issues/3951))

- go: bump google.golang.org/grpc to 1.38.0
  ([#3953](https://github.com/Orphiqprotocol/Orphiq-core/issues/3953))

- Bump Rust toolchain to 2021-05-20
  ([#3955](https://github.com/Orphiqprotocol/Orphiq-core/issues/3955))

- workload/governance: fix case with multiple equal active proposals
  ([#3959](https://github.com/Orphiqprotocol/Orphiq-core/issues/3959))
...
- go: bump github.com/uber/jaeger-client-go to 2.29.1+incompatible
  ([#3966](https://github.com/Orphiqprotocol/Orphiq-core/issues/3966))

- Bump grpcio to 0.9.0
  ([#3968](https://github.com/Orphiqprotocol/Orphiq-core/issues/3968))
...
- rust: bump crossbeam from 0.8.0 to 0.8.1
  ([#3977](https://github.com/Orphiqprotocol/Orphiq-core/issues/3977))

- go: bump github.com/multiformats/go-multiaddr from 0.3.1 to 0.3.2
  ([#3978](https://github.com/Orphiqprotocol/Orphiq-core/issues/3978))

- go: bump github.com/cenkalti/backoff/v4 from 4.1.0 to 4.1.1
  ([#3979](https://github.com/Orphiqprotocol/Orphiq-core/issues/3979))

- go: bump github.com/libp2p/go-libp2p from 0.14.0 to 0.14.1
  ([#3980](https://github.com/Orphiqprotocol/Orphiq-core/issues/3980))

- rust/Cargo.toml: specify exact ring depedency version
  ([#3981](https://github.com/Orphiqprotocol/Orphiq-core/issues/3981))

- runtime: Stop using the ring backend for snow
  ([#3990](https://github.com/Orphiqprotocol/Orphiq-core/issues/3990))

- rust: use 0.0.0 as crate versions
  ([#3995](https://github.com/Orphiqprotocol/Orphiq-core/issues/3995))

  Crates are following [Orphiq Core versioning scheme]. The crates are not
  ...
  [Orphiq core versioning scheme]:
    /Orphiq-core/processes/versioning

- go/worker/common: Wait for all child workers to initialize
  ([#4001](https://github.com/Orphiqprotocol/Orphiq-core/issues/4001))
...
- go/registry: Allow update from no key manager to with key manager
  ([#3802](https://github.com/Orphiqprotocol/Orphiq-core/issues/3802))

- go/common/entity: Rename `LatestEntityDescriptorVersion`
  ([#3845](https://github.com/Orphiqprotocol/Orphiq-core/issues/3845))
...
- storage: Drop the MKVS node version field
  ([#3500](https://github.com/Orphiqprotocol/Orphiq-core/issues/3500))
...
- Orphiq-net-runner: Configure a client node even without runtimes
  ([#3794](https://github.com/Orphiqprotocol/Orphiq-core/issues/3794))

- go/staking: Improve pretty-print for `Escrow`/`ReclaimEscrow` transactions
  ([#3819](https://github.com/Orphiqprotocol/Orphiq-core/issues/3819))
...
- go/worker/compute/executor: Enable scheduler transaction checks by default
  ([#3851](https://github.com/Orphiqprotocol/Orphiq-core/issues/3851))

### Bug Fixes

- Orphiq-net-runner: Configure a runtime in default fixture
  ([#3805](https://github.com/Orphiqprotocol/Orphiq-core/issues/3805))

- go/worker/storage: Fix Finalize and Apply failure handling
  ([#3820](https://github.com/Orphiqprotocol/Orphiq-core/issues/3820))

- go/storage: Fix failure handling in checkpoint syncing
  ([#3830](https://github.com/Orphiqprotocol/Orphiq-core/issues/3830))

  In some cases, the database could be left in a corrupt state after a
  checkpoint chunk failed to be restored.

- go/consensus/tendermint: Bump Tendermint Core to v0.34.9-Orphiq2
  ([#3844](https://github.com/Orphiqprotocol/Orphiq-core/issues/3844))

### Internal Changes

- go: bump github.com/golang/protobuf from 1.4.3 to 1.5.1
  ([#3799](https://github.com/Orphiqprotocol/Orphiq-core/issues/3799))

- go: bump github.com/prometheus/client_golang from 1.9.0 to 1.10.0
  ([#3803](https://github.com/Orphiqprotocol/Orphiq-core/issues/3803))

- go: bump github.com/prometheus/common from 0.19.0 to 0.20.0
  ([#3811](https://github.com/Orphiqprotocol/Orphiq-core/issues/3811))

- go: bump google.golang.org/grpc from 1.36.0 to 1.36.1
  ([#3816](https://github.com/Orphiqprotocol/Orphiq-core/issues/3816))
...
- go: bump github.com/golang/protobuf from 1.5.1 to 1.5.2
  ([#3821](https://github.com/Orphiqprotocol/Orphiq-core/issues/3821))

- go/worker/common: Iterate over all handlers on unhandled peer message
  ([#3838](https://github.com/Orphiqprotocol/Orphiq-core/issues/3838))

- go/runtime/client: Also recheck blocks periodically
  ([#3842](https://github.com/Orphiqprotocol/Orphiq-core/issues/3842))
...
- go/consensus/tendermint: Handle `LIGHT_CLIENT_ATTACK` evidence
  ([#3156](https://github.com/Orphiqprotocol/Orphiq-core/issues/3156))

- go/beacon: Add a PVSS based beacon backend
  ([#3180](https://github.com/Orphiqprotocol/Orphiq-core/issues/3180))
  ...
  <!-- markdownlint-disable line-length -->
  [ADR 0007]:
    https://github.com/Orphiqprotocol/adrs/blob/main/0007-improved-random-beacon.md
  <!-- markdownlint-enable line-length -->

- go: Use human readable identifiers for slashing reasons
  ([#3276](https://github.com/Orphiqprotocol/Orphiq-core/issues/3276),
   [#3646](https://github.com/Orphiqprotocol/Orphiq-core/issues/3646))
...
- go: Improve error message when delegating less than `MinDelegationAmount`
  ([#3308](https://github.com/Orphiqprotocol/Orphiq-core/issues/3308))
...
- go/worker/p2p: Include chain ID and remove patch version from topic IDs
  ([#3311](https://github.com/Orphiqprotocol/Orphiq-core/issues/3311))

- go: Move storage backend initialization to storage worker
  ([#3323](https://github.com/Orphiqprotocol/Orphiq-core/issues/3323))
...
- Compare protocol versions according to SemVer 2.0.0
  ([#3360](https://github.com/Orphiqprotocol/Orphiq-core/issues/3360))

  As described in our [Versioning] document, we bumped the protocol versions to
  version 1.0.0 with the release of [Orphiq Core 20.10].
  ...
  [Orphiq Core 20.10]:
    https://github.com/Orphiqprotocol/Orphiq-core/blob/v20.10/CHANGELOG.md

- go/common/version: Remove `MajorMinor()` method from `Version` type
  ([#3360](https://github.com/Orphiqprotocol/Orphiq-core/issues/3360))

- roothash: Add support for failure indicating commitments
  ([#3391](https://github.com/Orphiqprotocol/Orphiq-core/issues/3391))
  ...
  <!-- markdownlint-disable line-length -->
  [ADR 0005]:
    https://github.com/Orphiqprotocol/adrs/blob/main/0005-runtime-compute-slashing.md
  <!-- markdownlint-enable line-length -->

- Introduce storage root types
  ([#3415](https://github.com/Orphiqprotocol/Orphiq-core/issues/3415))
...
- go/staking: Add support for beneficiary allowances
  ([#3428](https://github.com/Orphiqprotocol/Orphiq-core/issues/3428))
  ...
  <!-- markdownlint-disable line-length -->
  [ADR 0003]:
    https://github.com/Orphiqprotocol/adrs/blob/main/0003-consensus-runtime-token-transfer.md
  <!-- markdownlint-enable line-length -->

- Add runtime accounts in the consensus layer
  ([#3429](https://github.com/Orphiqprotocol/Orphiq-core/issues/3429))
...
- go/roothash: Refactor runtime messages
  ([#3430](https://github.com/Orphiqprotocol/Orphiq-core/issues/3430))
...
- go/roothash: Renamed `FinalizedEvent` field in `roothash.Event`
  ([#3448](https://github.com/Orphiqprotocol/Orphiq-core/issues/3448))
...
- Remove `SignedRuntime`
  ([#3450](https://github.com/Orphiqprotocol/Orphiq-core/issues/3450))
  ...
  This also affects the genesis file. Use the `Orphiq-node debug fix-genesis`
  command to convert a genesis file from the old format to the new one.

  [ADR 0004]:
    https://github.com/Orphiqprotocol/adrs/blob/main/0004-runtime-governance.md
...
- go/consensus/tendermint: Use canonical chain context in InitChain
  ([#3477](https://github.com/Orphiqprotocol/Orphiq-core/issues/3477))

- go/roothash/genesis: Restore state from suspended runtimes
  ([#3484](https://github.com/Orphiqprotocol/Orphiq-core/issues/3484))
...
- Implement Consensus Governance backend
  ([#3502](https://github.com/Orphiqprotocol/Orphiq-core/issues/3502))
  ...
  [ADR 0006]:
    https://github.com/Orphiqprotocol/adrs/blob/main/0006-consensus-governance.md
...
- runtime: Move consensus layer structures to its own module
  ([#3511](https://github.com/Orphiqprotocol/Orphiq-core/issues/3511))

  Everything under `common::{address, registry, roothash, staking}` in the
  `Orphiq-core-runtime` crate has been moved under the `consensus` module.

- go/consensus/api: Rename `ConsensusVersion` to `Version` in `Status` type
  ([#3511](https://github.com/Orphiqprotocol/Orphiq-core/issues/3511))

- go/upgrade: Support multiple pending upgrades
  ([#3536](https://github.com/Orphiqprotocol/Orphiq-core/issues/3536))
...
- go/registry/api: Allow updating more fields when updating an expired node
  ([#3539](https://github.com/Orphiqprotocol/Orphiq-core/issues/3539))
...
- go/Orphiq-node/cmd/stake: Enhance `account info`'s output
  ([#3557](https://github.com/Orphiqprotocol/Orphiq-core/issues/3557))
...
- go/consensus: Include consensus genesis parameters in `GetParameters`
  ([#3565](https://github.com/Orphiqprotocol/Orphiq-core/issues/3565))

  Consensus `GetParameters` method response now includes the consensus genesis
  parameters.

- runtime: Make `CheckTx` result more generic
  ([#3573](https://github.com/Orphiqprotocol/Orphiq-core/issues/3573))
...
- go/upgrade: Use `ProtocolVersions` as internal upgrade identifier
  ([#3579](https://github.com/Orphiqprotocol/Orphiq-core/issues/3579))
...
- Add ability to set a non-zero initial commission schedule
  ([#3601](https://github.com/Orphiqprotocol/Orphiq-core/issues/3601))
...
- go/scheduler: Check runtime versions for node eligibility
  ([#3611](https://github.com/Orphiqprotocol/Orphiq-core/issues/3611))

- go/roothash/api/message: Add `RegistryMessage` runtime message
  ([#3628](https://github.com/Orphiqprotocol/Orphiq-core/issues/3628))
...
- runtime: Remove `common::runtime::RuntimeId`
  ([#3633](https://github.com/Orphiqprotocol/Orphiq-core/issues/3633))
...
- go/roothash: Support slashing runtime compute nodes
  ([#3640](https://github.com/Orphiqprotocol/Orphiq-core/issues/3640))
...
- runtimes: Support for `Add/ReclaimEscrow` runtime messages
  ([#3641](https://github.com/Orphiqprotocol/Orphiq-core/issues/3641))
...
- go/roothash: Runtime domain separation context in executor commitments
  ([#3643](https://github.com/Orphiqprotocol/Orphiq-core/issues/3643))

- Add runtime scheduling constraints
  ([#3644](https://github.com/Orphiqprotocol/Orphiq-core/issues/3644))
...
- go/registry: Fix node sanity checks
  ([#3660](https://github.com/Orphiqprotocol/Orphiq-core/issues/3660))

- Remove support for entity-signed node registrations
  ([#3661](https://github.com/Orphiqprotocol/Orphiq-core/issues/3661))
...
- go/registry: Change minimum `ProposerTimeout` from 5 to 2 blocks
  ([#3682](https://github.com/Orphiqprotocol/Orphiq-core/issues/3682))

- go/genesis/api: Change canonical form of genesis file to end with a newline
  ([#3709](https://github.com/Orphiqprotocol/Orphiq-core/issues/3709))

- go/staking/state: Remove nonce as the debonding delegations disambiguator
  ([#3717](https://github.com/Orphiqprotocol/Orphiq-core/issues/3717))
...
- runtime: Introduce `RoundResults` to allow adding other information
  ([#3726](https://github.com/Orphiqprotocol/Orphiq-core/issues/3726))
...
- go/staking/api: Rename `Delegations()` method to `DelegationsFor()`
  ([#3774](https://github.com/Orphiqprotocol/Orphiq-core/issues/3774))
...
- go/upgrade/api: Version upgrade `Descriptor`
  ([#3781](https://github.com/Orphiqprotocol/Orphiq-core/issues/3781))

- go/consensus: Store runtime state roots in a single key
  ([#3782](https://github.com/Orphiqprotocol/Orphiq-core/issues/3782))
...
- go/staking/api/token: Print token's symbol after the amount
  ([#3784](https://github.com/Orphiqprotocol/Orphiq-core/issues/3784))
...
- go/consensus/tendermint: Bump Tendermint Core to v0.34.8-Orphiq1
  ([#3786](https://github.com/Orphiqprotocol/Orphiq-core/issues/3786))

- go/roothash: Finish commitment processing early when possible
  ([#3790](https://github.com/Orphiqprotocol/Orphiq-core/issues/3790))
...
- go/upgrade/api: Simplify upgrade `Descriptor`
  ([#3793](https://github.com/Orphiqprotocol/Orphiq-core/issues/3793))
...
- Change compute worker runtime configuration flags
  ([#3653](https://github.com/Orphiqprotocol/Orphiq-core/issues/3653))
...
- go/worker/storage: Add validation for IO roots in `Apply` operations
  ([#3440](https://github.com/Orphiqprotocol/Orphiq-core/issues/3440))

- go/runtime/client: Add `SubmitTxNoWait` method
  ([#3444](https://github.com/Orphiqprotocol/Orphiq-core/issues/3444))
...
- Runtime client should fail `SubmitTx` calls until consensus is synced
  ([#3452](https://github.com/Orphiqprotocol/Orphiq-core/issues/3452))

- Runtime storage sync should use any storage node
  ([#3454](https://github.com/Orphiqprotocol/Orphiq-core/issues/3454))
...
- go/Orphiq-node/cmd: Add `Orphiq-node stake account validate_address` CLI command
  ([#3493](https://github.com/Orphiqprotocol/Orphiq-core/issues/3493),
   [#3589](https://github.com/Orphiqprotocol/Orphiq-core/issues/3589))

  It can be used to validate a staking account's address.

- runtime: Add `mkvs::Iterator` trait and `MKVS::iter` trait method
  ([#3499](https://github.com/Orphiqprotocol/Orphiq-core/issues/3499))
...
- go/Orphiq-node/cmd/stake: Add commands for managing allowances
  ([#3511](https://github.com/Orphiqprotocol/Orphiq-core/issues/3511))

  Add `Orphiq-node stake account gen_allow` and
  `Orphiq-node stake account gen_withdraw` CLI commands.

- go/consensus/tendermint: Also dump state when shutting down for upgrade
  ([#3516](https://github.com/Orphiqprotocol/Orphiq-core/issues/3516))

- go/common/version: Add `ConvertGoModulesVersion()` function
  ([#3546](https://github.com/Orphiqprotocol/Orphiq-core/issues/3546))
  ...
  the canonical Orphiq Core version.

  <!-- markdownlint-disable line-length -->
  [ADR 0002]:
    https://github.com/Orphiqprotocol/adrs/blob/main/0002-go-modules-compatible-git-tags.md
  <!-- markdownlint-enable line-length -->

- go/Orphiq-node/cmd: Add `Orphiq-node stake account nonce` CLI command
  ([#3559](https://github.com/Orphiqprotocol/Orphiq-core/issues/3559))
...
- go/worker/executor: Propose a new batch if there are message results
  ([#3645](https://github.com/Orphiqprotocol/Orphiq-core/issues/3645))
...
- runtime: Add support for runtime-specific queries
  ([#3662](https://github.com/Orphiqprotocol/Orphiq-core/issues/3662))
...
- go/worker/storage: Add `StorageRPC` role and change access policy
  ([#3696](https://github.com/Orphiqprotocol/Orphiq-core/issues/3696))
...
- go/staking/api/token: Generalize `PrettyPrintAmount()`
  ([#3725](https://github.com/Orphiqprotocol/Orphiq-core/issues/3725))
...
- go/control/GetStatus: Include the latest epoch
  ([#3743](https://github.com/Orphiqprotocol/Orphiq-core/issues/3743))

- go/runtime/registry: Add methods returning active runtime descriptors
  ([#3771](https://github.com/Orphiqprotocol/Orphiq-core/issues/3771))
...
- go/beacon: Add `GetFutureEpoch` method to beacon API
  ([#3773](https://github.com/Orphiqprotocol/Orphiq-core/issues/3773))
...
- runtime: Provide consensus layer chain domain separation context
  ([#3778](https://github.com/Orphiqprotocol/Orphiq-core/issues/3778))
...
- go/staking/api/token: Add support for passing token's value sign via context
  ([#3780](https://github.com/Orphiqprotocol/Orphiq-core/issues/3780))

- go/control/api: Add node status to registration status response
  ([#3783](https://github.com/Orphiqprotocol/Orphiq-core/issues/3783))

- go/Orphiq-node/cmd: Improve transaction preview when generating transactions
  ([#3792](https://github.com/Orphiqprotocol/Orphiq-core/issues/3792))

  Display amounts in tokens and display genesis document's hash when previewing
  transactions with various `Orphiq-node * gen_*` CLI commands.

- go/Orphiq-node/cmd/common/context: Add `GetCtxWithGenesisInfo()` helper
  ([#3792](https://github.com/Orphiqprotocol/Orphiq-core/issues/3792))

- go/upgrade: Implement `PrettyPrint` interface for `Descriptor`
  ([#3800](https://github.com/Orphiqprotocol/Orphiq-core/issues/3800))
...
- go/consensus: Include only top K validators at genesis time
  ([#3177](https://github.com/Orphiqprotocol/Orphiq-core/issues/3177))
...
- go/storage/mkvs/checkpoint: Fix handling of non-zero earliest version
  ([#3480](https://github.com/Orphiqprotocol/Orphiq-core/issues/3480))

- go/consensus/tendermint: Fix early `GetStatus()` with initial height > 1
  ([#3481](https://github.com/Orphiqprotocol/Orphiq-core/issues/3481))

- go: Add missing size checks to `UnmarshalBinary()` methods
  ([#3497](https://github.com/Orphiqprotocol/Orphiq-core/issues/3497))
...
- go/Orphiq-node/cmd/registry/entity: Reuse signer instead of creating a new one
  ([#3505](https://github.com/Orphiqprotocol/Orphiq-core/issues/3505))

  The `Orphiq-node registry entity register` CLI command previously always
...
- Bump Go to 1.15.5
  ([#3512](https://github.com/Orphiqprotocol/Orphiq-core/issues/3512))
...
- go/worker/registration: Fix `RequestShutdown` for nodes with no registration
  ([#3524](https://github.com/Orphiqprotocol/Orphiq-core/issues/3524))
...
- go/worker/storage: Fill in additional versions when restoring state
  ([#3525](https://github.com/Orphiqprotocol/Orphiq-core/issues/3525))
...
- go/consensus/tendermint: Report peers and validator status only after started
  ([#3534](https://github.com/Orphiqprotocol/Orphiq-core/issues/3534))
...
- go/worker/storage: Force checkpoint sync when replication is needed
  ([#3538](https://github.com/Orphiqprotocol/Orphiq-core/issues/3538))
...
- go/roothash/api/commitment: Return proposer commit in DR
  ([#3545](https://github.com/Orphiqprotocol/Orphiq-core/issues/3545))
...
- go/runtime/scheduling: Consumer should pull from scheduler
  ([#3569](https://github.com/Orphiqprotocol/Orphiq-core/issues/3569))
...
- go/consensus/tendermint/roothash: Fix latest block reindexing
  ([#3594](https://github.com/Orphiqprotocol/Orphiq-core/issues/3594))
...
- go/worker/common/committee: Wait for initial consensus sync
  ([#3599](https://github.com/Orphiqprotocol/Orphiq-core/issues/3599))

- go/consensus/tendermint: Fix `nil` dereference in `EstimateGas`
  ([#3648](https://github.com/Orphiqprotocol/Orphiq-core/issues/3648))

- go/Orphiq-node/cmd/node: Fix error handling when writing in `dumpGenesis()`
  ([#3714](https://github.com/Orphiqprotocol/Orphiq-core/issues/3714))

- go/cmd/fixgenesis: Add default beacon and governance parameters
  ([#3728](https://github.com/Orphiqprotocol/Orphiq-core/issues/3728))
...
- go/consensus: Exclude expired nodes from validator set at genesis time
  ([#3763](https://github.com/Orphiqprotocol/Orphiq-core/issues/3763))

  The validator set selection algorithm now properly ignores expired nodes.

- go/upgrade: Ensure upgrade handler exists
  ([#3768](https://github.com/Orphiqprotocol/Orphiq-core/issues/3768))
...
- go/roothash/reindexBlocks: Return latest known round if no new rounds indexed
  ([#3791](https://github.com/Orphiqprotocol/Orphiq-core/issues/3791))
...
- go/worker/executor: Avoid holding lock while applying processed batch
  ([#3801](https://github.com/Orphiqprotocol/Orphiq-core/issues/3801))
...
- ADR 0003: Consensus/Runtime Token Transfer
  ([#3262](https://github.com/Orphiqprotocol/Orphiq-core/issues/3262))

- ADR 0004: Runtime Governance
  ([#3284](https://github.com/Orphiqprotocol/Orphiq-core/issues/3284))

- Document [genesis document's hash]
  ([#3312](https://github.com/Orphiqprotocol/Orphiq-core/issues/3312))

  [genesis document's hash]: docs/consensus/genesis.md#genesis-documents-hash

- Update [Release Process] documentation
  ([#3327](https://github.com/Orphiqprotocol/Orphiq-core/issues/3327))

  [Release Process]: docs/release-process.md

- ADR 0005: Runtime Compute Node Slashing
  ([#3339](https://github.com/Orphiqprotocol/Orphiq-core/issues/3339))

- Rename Versioning scheme document to Versioning and include it in the index
  ([#3360](https://github.com/Orphiqprotocol/Orphiq-core/issues/3360))

- docs: Fix some links that break with gitbook
  ([#3389](https://github.com/Orphiqprotocol/Orphiq-core/issues/3389))

- ADR 0006: Consensus Governance
  ([#3423](https://github.com/Orphiqprotocol/Orphiq-core/issues/3423))

- ADR 0007: Improved Random Beacon
  ([#3439](https://github.com/Orphiqprotocol/Orphiq-core/issues/3439))

- Update Deploying a Runtime document's example
  ([#3789](https://github.com/Orphiqprotocol/Orphiq-core/issues/3789))

### Internal Changes

- ci: Setup daily longterm tests with longer epoch periods
  ([#3301](https://github.com/Orphiqprotocol/Orphiq-core/issues/3301))

- Omit node operator link from release notes
  ([#3313](https://github.com/Orphiqprotocol/Orphiq-core/issues/3313))

- go: Bump github.com/prometheus/procfs from 0.1.3 to 0.3.0
  ([#3314](https://github.com/Orphiqprotocol/Orphiq-core/issues/3314),
   [#3616](https://github.com/Orphiqprotocol/Orphiq-core/issues/3616))
...
- internal: Refactor project's version handling
  ([#3327](https://github.com/Orphiqprotocol/Orphiq-core/issues/3327),
   [#3345](https://github.com/Orphiqprotocol/Orphiq-core/issues/3345),
   [#3492](https://github.com/Orphiqprotocol/Orphiq-core/issues/3492))
...
- Make: Refactor release-related targets
  ([#3327](https://github.com/Orphiqprotocol/Orphiq-core/issues/3327),
   [#3368](https://github.com/Orphiqprotocol/Orphiq-core/issues/3368))
...
- github: Bump GoReleaser in ci-reproducibility and release workflows to 0.152.0
  ([#3327](https://github.com/Orphiqprotocol/Orphiq-core/issues/3327),
   [#3368](https://github.com/Orphiqprotocol/Orphiq-core/issues/3368),
   [#3602](https://github.com/Orphiqprotocol/Orphiq-core/issues/3602))

- go/e2e/workload-queries: Allow historical `QueryTxs` to fail few times
  ([#3338](https://github.com/Orphiqprotocol/Orphiq-core/issues/3338))

- go/nancy: Remove `golang.org/x/net` false positive ignores
  ([#3340](https://github.com/Orphiqprotocol/Orphiq-core/issues/3340))

- go/dependencies/etcd: Update etcd with replace directive
  ([#3341](https://github.com/Orphiqprotocol/Orphiq-core/issues/3341))

- ci: Bump actions/setup-python from v2.1.2 to v2.2.1
  ([#3349](https://github.com/Orphiqprotocol/Orphiq-core/issues/3349),
   [#3405](https://github.com/Orphiqprotocol/Orphiq-core/issues/3405),
   [#3582](https://github.com/Orphiqprotocol/Orphiq-core/issues/3582))

- rust: Bump base64 from 0.12.3 to 0.13.0
  ([#3353](https://github.com/Orphiqprotocol/Orphiq-core/issues/3353))

- Prioritize nodes that signed storage receipts
  ([#3354](https://github.com/Orphiqprotocol/Orphiq-core/issues/3354))
...
- ci: Bump actions/setup-node from v2.1.1 to v2.1.4
  ([#3364](https://github.com/Orphiqprotocol/Orphiq-core/issues/3364),
   [#3563](https://github.com/Orphiqprotocol/Orphiq-core/issues/3563),
   [#3575](https://github.com/Orphiqprotocol/Orphiq-core/issues/3575))

- ci: Bump actions/setup-go from v2.1.2 to v2.1.3
  ([#3365](https://github.com/Orphiqprotocol/Orphiq-core/issues/3365))

- ci: Bump actions/upload-artifact from v2.1.4 to v2.2.2
  ([#3367](https://github.com/Orphiqprotocol/Orphiq-core/issues/3367),
   [#3520](https://github.com/Orphiqprotocol/Orphiq-core/issues/3520),
   [#3596](https://github.com/Orphiqprotocol/Orphiq-core/issues/3596))

- go/Orphiq-test-runner: Fix `e2e/consensus-state-sync` scenario (take two)
  ([#3369](https://github.com/Orphiqprotocol/Orphiq-core/issues/3369))
...
- go/e2e/queries: Correctly ignore `UnexpectedEOF` errors
  ([#3372](https://github.com/Orphiqprotocol/Orphiq-core/issues/3372))

- ci: Make build-fuzz failures fatal now that upstream is fixed
  ([#3374](https://github.com/Orphiqprotocol/Orphiq-core/issues/3374))

- go: Bump github.com/blevesearch/bleve from 1.0.10 to 1.0.14
  ([#3384](https://github.com/Orphiqprotocol/Orphiq-core/issues/3384),
   [#3530](https://github.com/Orphiqprotocol/Orphiq-core/issues/3530),
   [#3558](https://github.com/Orphiqprotocol/Orphiq-core/issues/3558))

- ci: Daily long-term test minor fixes
  ([#3387](https://github.com/Orphiqprotocol/Orphiq-core/issues/3387))
...
- go: Bump github.com/libp2p/go-libp2p-pubsub from 0.3.5 to 0.4.1
  ([#3392](https://github.com/Orphiqprotocol/Orphiq-core/issues/3392),
   [#3510](https://github.com/Orphiqprotocol/Orphiq-core/issues/3510),
   [#3624](https://github.com/Orphiqprotocol/Orphiq-core/issues/3624))

- go/e2e/runtime/runtime-upgrade: Wait for old compute nodes to expire
  ([#3404](https://github.com/Orphiqprotocol/Orphiq-core/issues/3404))

- go: Bump github.com/golang/protobuf from 1.4.2 to 1.4.3
  ([#3408](https://github.com/Orphiqprotocol/Orphiq-core/issues/3408))

- go/e2e: Add storage byzantine E2E test cases
  ([#3414](https://github.com/Orphiqprotocol/Orphiq-core/issues/3414))

- go: Bump github.com/prometheus/client_golang from 1.7.1 to 1.9.0
  ([#3419](https://github.com/Orphiqprotocol/Orphiq-core/issues/3419),
   [#3576](https://github.com/Orphiqprotocol/Orphiq-core/issues/3576))

- go: Bump github.com/spf13/cobra from 1.0.0 to 1.1.1
  ([#3427](https://github.com/Orphiqprotocol/Orphiq-core/issues/3427))

- go: Bump google.golang.org/grpc from 1.32.0 to 1.36.0
  ([#3437](https://github.com/Orphiqprotocol/Orphiq-core/issues/3437),
   [#3495](https://github.com/Orphiqprotocol/Orphiq-core/issues/3495),
   [#3543](https://github.com/Orphiqprotocol/Orphiq-core/issues/3543),
   [#3617](https://github.com/Orphiqprotocol/Orphiq-core/issues/3617),
   [#3631](https://github.com/Orphiqprotocol/Orphiq-core/issues/3631),
   [#3730](https://github.com/Orphiqprotocol/Orphiq-core/issues/3730))

- rust: Bump rustracing
  ([#3446](https://github.com/Orphiqprotocol/Orphiq-core/issues/3446))
...
- go/common/crash: Improvements to the debug crash framework
  ([#3449](https://github.com/Orphiqprotocol/Orphiq-core/issues/3449))
...
- go: Bump github.com/hashicorp/go-plugin from 1.3.0 to 1.4.0
  ([#3494](https://github.com/Orphiqprotocol/Orphiq-core/issues/3494))

- go: Bump github.com/hashicorp/go-hclog from 0.14.1 to 0.15.0
  ([#3496](https://github.com/Orphiqprotocol/Orphiq-core/issues/3496))

- go/Orphiq-node/cmd/common/consensus: Augment `SignAndSaveTx()` with `signer`
  ([#3506](https://github.com/Orphiqprotocol/Orphiq-core/issues/3506))
...
- go: Bump github.com/libp2p/go-libp2p-core from 0.6.1 to 0.8.5
  ([#3510](https://github.com/Orphiqprotocol/Orphiq-core/issues/3510),
   [#3711](https://github.com/Orphiqprotocol/Orphiq-core/issues/3711),
   [#3718](https://github.com/Orphiqprotocol/Orphiq-core/issues/3718))

- go: Bump github.com/libp2p/go-libp2p from 0.11.0 to 0.13.0
  ([#3510](https://github.com/Orphiqprotocol/Orphiq-core/issues/3510),
   [#3588](https://github.com/Orphiqprotocol/Orphiq-core/issues/3588))

- rust: Bump arc-swap to 0.4.8
  ([#3511](https://github.com/Orphiqprotocol/Orphiq-core/issues/3511))

- ci: Bump actions/download-artifact from v2.0.5 to v2.0.8
  ([#3519](https://github.com/Orphiqprotocol/Orphiq-core/issues/3519),
   [#3571](https://github.com/Orphiqprotocol/Orphiq-core/issues/3571),
   [#3597](https://github.com/Orphiqprotocol/Orphiq-core/issues/3597))

- github: Replace deprecated `set-env` workflow command with environment file
  ([#3522](https://github.com/Orphiqprotocol/Orphiq-core/issues/3522))
...
- ci: Bump docker/build-push-action from v1 to v2.2.2
  ([#3549](https://github.com/Orphiqprotocol/Orphiq-core/issues/3549),
   [#3605](https://github.com/Orphiqprotocol/Orphiq-core/issues/3605))

- go/Orphiq-node/cmd/common: Add `LoadEntitySigner()` helper
  ([#3556](https://github.com/Orphiqprotocol/Orphiq-core/issues/3556))
...
- go/Orphiq-node/txsource: Increase submission timeout
  ([#3568](https://github.com/Orphiqprotocol/Orphiq-core/issues/3568))
...
- dependencies: Update bubblewrap to 0.4.1
  ([#3577](https://github.com/Orphiqprotocol/Orphiq-core/issues/3577))

- go/Orphiq-node/txsource: Fix event validation in queries workload
  ([#3593](https://github.com/Orphiqprotocol/Orphiq-core/issues/3593))
...
- go/e2e/txsource: Add txsource SGX scenario using fewer nodes
  ([#3595](https://github.com/Orphiqprotocol/Orphiq-core/issues/3595))

- go/Orphiq-test-runner/txsource: Add governance workload
  ([#3603](https://github.com/Orphiqprotocol/Orphiq-core/issues/3603))

- rust: Bump smallvec to 0.6.14
  ([#3604](https://github.com/Orphiqprotocol/Orphiq-core/issues/3604))

- runtime/storage/mkvs: Add MKVS impl for `&mut T`
  ([#3604](https://github.com/Orphiqprotocol/Orphiq-core/issues/3604))

- go/e2e/governance-upgrade: Wait for compute nodes to be ready
  ([#3618](https://github.com/Orphiqprotocol/Orphiq-core/issues/3618))

- rust: Bump honggfuzz from 0.5.51 to 0.5.52
  ([#3621](https://github.com/Orphiqprotocol/Orphiq-core/issues/3621))

- rust: Bump slog-scope from 4.3.0 to 4.4.0
  ([#3622](https://github.com/Orphiqprotocol/Orphiq-core/issues/3622))

- go/common/cbor: Re-export `Marshaler` and `Unmarshaler` interfaces
  ([#3630](https://github.com/Orphiqprotocol/Orphiq-core/issues/3630))

- go: Bump github.com/stretchr/testify from 1.6.1 to 1.7.0
  ([#3632](https://github.com/Orphiqprotocol/Orphiq-core/issues/3632))

- runtime: Validate block namespace against runtime ID
  ([#3633](https://github.com/Orphiqprotocol/Orphiq-core/issues/3633))

- go/Orphiq-test-runner/txsource: Decrease `MinPoolSize` for restarts
  ([#3636](https://github.com/Orphiqprotocol/Orphiq-core/issues/3636))
...
- go: Bump ed25519 for fixes on 32-bit architectures
  ([#3657](https://github.com/Orphiqprotocol/Orphiq-core/issues/3657))

  Note that 32-bit architectures are not supported by Orphiq Core.
...
- tests: Fix potential key clash in the confidential test KV runtime
  ([#3663](https://github.com/Orphiqprotocol/Orphiq-core/issues/3663))

  This was responsible for some E2E test flakiness.

- beacon: Add a minimal gRPC service
  ([#3666](https://github.com/Orphiqprotocol/Orphiq-core/issues/3666))

- go/worker/beacon: Fix a state recovery edge case
  ([#3668](https://github.com/Orphiqprotocol/Orphiq-core/issues/3668))

- go/consensus/tendermint/abci/mux: Reject early `EstimateGas` calls
  ([#3669](https://github.com/Orphiqprotocol/Orphiq-core/issues/3669))
...
- go/consensus: Add support for method priority
  ([#3675](https://github.com/Orphiqprotocol/Orphiq-core/issues/3675))

- go/Orphiq-node/cmd/common/metrics: Fix label escaping
  ([#3678](https://github.com/Orphiqprotocol/Orphiq-core/issues/3678))

- Make sure tracing is only enabled in debug mode
  ([#3679](https://github.com/Orphiqprotocol/Orphiq-core/issues/3679))

- rust: Bump bech32 from 0.7.2 to 0.8.0
  ([#3699](https://github.com/Orphiqprotocol/Orphiq-core/issues/3699))

- go/Orphiq-test-runner: Add support for configuring `pprof`
  ([#3719](https://github.com/Orphiqprotocol/Orphiq-core/issues/3719))

  Adds support for configuring `pprof` on the test nodes.

- go/Orphiq-test-runner: Configurable supplementary sanity checker
  ([#3719](https://github.com/Orphiqprotocol/Orphiq-core/issues/3719))
...
- Make: Remove `build-go` target's `go` alias
  ([#3722](https://github.com/Orphiqprotocol/Orphiq-core/issues/3722))

- Make: Add `lint-go-mod-tidy` target
  ([#3722](https://github.com/Orphiqprotocol/Orphiq-core/issues/3722))

- go: Bump github.com/golang/snappy from 0.0.2 to 0.0.3
  ([#3735](https://github.com/Orphiqprotocol/Orphiq-core/issues/3735))

- rust: Bump aesm-client from 0.5.1 to 0.5.2
  ([#3742](https://github.com/Orphiqprotocol/Orphiq-core/issues/3742))

- runtime/common/quantity: Add `Mul/Div` implementations
  ([#3744](https://github.com/Orphiqprotocol/Orphiq-core/issues/3744))

- go/nodes/grpc: Tweak backoff timeouts
  ([#3757](https://github.com/Orphiqprotocol/Orphiq-core/issues/3757))
...
- go: Bump github.com/hashicorp/go-multierror from 1.1.0 to 1.1.1
  ([#3777](https://github.com/Orphiqprotocol/Orphiq-core/issues/3777))

- go: Bump github.com/prometheus/common to 0.19.0
  ([#3779](https://github.com/Orphiqprotocol/Orphiq-core/issues/3779))
...
- go/common/crypto: Bump ed25519 version
  ([#3458](https://github.com/Orphiqprotocol/Orphiq-core/issues/3458),
   [#3470](https://github.com/Orphiqprotocol/Orphiq-core/issues/3470),
   [#3471](https://github.com/Orphiqprotocol/Orphiq-core/issues/3471))

### Configuration Changes

- go/runtime/scheduling: Max queue size flag rename
  ([#3434](https://github.com/Orphiqprotocol/Orphiq-core/issues/3434))
...
- go/runtime/client: Add max transaction age
  ([#3443](https://github.com/Orphiqprotocol/Orphiq-core/issues/3443))
...
- go/runtime/client: Runtime client should retry processing any failed blocks
  ([#3412](https://github.com/Orphiqprotocol/Orphiq-core/issues/3412))

- go/storage/client: Retry `ErrNodeNotFound` errors on write requests
  ([#3424](https://github.com/Orphiqprotocol/Orphiq-core/issues/3424))

- go/worker/common: check if active epoch exists in HandlePeerMsg
  ([#3432](https://github.com/Orphiqprotocol/Orphiq-core/issues/3432))
...
- Storage node should update access control policy on new node registrations
  ([#3453](https://github.com/Orphiqprotocol/Orphiq-core/issues/3453))
...
- rust: Bump futures to 0.3.7
  ([#3460](https://github.com/Orphiqprotocol/Orphiq-core/issues/3460))
...
- go/storage/mkvs: Fix Finalize after checkpoint restore
  ([#3330](https://github.com/Orphiqprotocol/Orphiq-core/issues/3330))

### Internal Changes

- go/storage/mkvs: Add node tracking to chunk restore
  ([#3241](https://github.com/Orphiqprotocol/Orphiq-core/issues/3241))

- go: Add ability to set initial block height at genesis
  ([#3416](https://github.com/Orphiqprotocol/Orphiq-core/issues/3416))
...
- go/runtime/client: remove unneeded P2P message republishing
  ([#3325](https://github.com/Orphiqprotocol/Orphiq-core/issues/3325))

### Bug Fixes

- go/worker/p2p: Skip peer authentication for our own messages
  ([#3319](https://github.com/Orphiqprotocol/Orphiq-core/issues/3319))
...
- go/worker/executor: don't unnecessarily hold the lock during storage requests
  ([#3320](https://github.com/Orphiqprotocol/Orphiq-core/issues/3320))

- go/worker/executor: only remove incoming transactions on finalized round
  ([#3332](https://github.com/Orphiqprotocol/Orphiq-core/issues/3332))
...
- go/worker/common/committee: group version should be the epoch block
  ([#3347](https://github.com/Orphiqprotocol/Orphiq-core/issues/3347))
...
- go/consensus/tendermint: Backport bug fixes
  ([#3398](https://github.com/Orphiqprotocol/Orphiq-core/issues/3398))

### Internal Changes

- go/backoff: Update `cenkalti/backoff` to 4.1.0
  ([#3390](https://github.com/Orphiqprotocol/Orphiq-core/issues/3390))

- rust: bump crossbeam from 0.7.3 to 0.8.0
  ([#3394](https://github.com/Orphiqprotocol/Orphiq-core/issues/3394))
...
- go/consensus: add last retained block information
  ([#3348](https://github.com/Orphiqprotocol/Orphiq-core/issues/3348))
...
- go: Update to build on macOS
  ([#3333](https://github.com/Orphiqprotocol/Orphiq-core/issues/3333))
...
- go/worker/p2p: Configurable libp2p buffer sizes
  ([#3264](https://github.com/Orphiqprotocol/Orphiq-core/issues/3264))
...
- Introduce the *canonical* form of a Genesis file
  ([#2757](https://github.com/Orphiqprotocol/Orphiq-core/issues/2757))
  ...
  The `Orphiq-node genesis init` and `Orphiq-node genesis dump` CLI commands are
...
- go/staking/api: Add `PrettyPrintCommissionScheduleIndexInfixes()` helper
  ([#3265](https://github.com/Orphiqprotocol/Orphiq-core/issues/3265))
...
- go/worker/executor: Cache last seen runtime transactions
  ([#3274](https://github.com/Orphiqprotocol/Orphiq-core/issues/3274))
...
- go/worker/p2p: Use hash of the message payload as message ID
  ([#3275](https://github.com/Orphiqprotocol/Orphiq-core/issues/3275))

- go/Orphiq-node: Make `Orphiq-node genesis check` command check if form canonical
  ([#3298](https://github.com/Orphiqprotocol/Orphiq-core/issues/3298))
...
- go/consensus/tendermint: Don't swallow recheck result errors
  ([#3267](https://github.com/Orphiqprotocol/Orphiq-core/issues/3267))

- go/runtime/client: Fix possible panic on shutdown
  ([#3271](https://github.com/Orphiqprotocol/Orphiq-core/issues/3271))

- go/worker/registration: Verify entity exists before node registration
  ([#3286](https://github.com/Orphiqprotocol/Orphiq-core/issues/3286))
...
- go/runtime/host/protocol: Set connection write deadline
  ([#3289](https://github.com/Orphiqprotocol/Orphiq-core/issues/3289))
...
- go/worker/executor: Clear tx queue before returning to committee
  ([#3300](https://github.com/Orphiqprotocol/Orphiq-core/issues/3300))
...
- go/Orphiq-node: Start internal gRPC server before consensus backend
  ([#3303](https://github.com/Orphiqprotocol/Orphiq-core/issues/3303))

### Documentation Improvements

- Document [`Orphiq-node genesis` CLI commands]
  ([#3298](https://github.com/Orphiqprotocol/Orphiq-core/issues/3298))

  [`Orphiq-node genesis` CLI commands]: docs/Orphiq-node/cli.md#genesis

### Internal Changes

- ci/txsource: Shut down nodes for longer period of time
  ([#3223](https://github.com/Orphiqprotocol/Orphiq-core/issues/3223))

- rust: Update tiny-keccak, hmac, sha2 dependencies
  ([#3260](https://github.com/Orphiqprotocol/Orphiq-core/issues/3260))

- go/extra/stats: Remove the unmaintained `extra/stats` tool
  ([#3270](https://github.com/Orphiqprotocol/Orphiq-core/issues/3270))

- go/Orphiq-test-runner: Add `e2e/genesis-file` scenario
  ([#3278](https://github.com/Orphiqprotocol/Orphiq-core/issues/3278))

- go/ci: Update nancy to 1.0.0
  ([#3283](https://github.com/Orphiqprotocol/Orphiq-core/issues/3283))

- go/consensus/tests: Use explicit latest height when comparing query results
  ([#3287](https://github.com/Orphiqprotocol/Orphiq-core/issues/3287))
...
- go/e2e/sentry: Sanity check consensus peers
  ([#3291](https://github.com/Orphiqprotocol/Orphiq-core/issues/3291))
...
- rust: Bump serde crates
  ([#3294](https://github.com/Orphiqprotocol/Orphiq-core/issues/3294))
...
- rust: Bump snow version from 0.6.2 to 0.7.1
  ([#3296](https://github.com/Orphiqprotocol/Orphiq-core/issues/3296))

- go: Bump github.com/golang/snappy from 0.0.1 to 0.0.2
  ([#3297](https://github.com/Orphiqprotocol/Orphiq-core/issues/3297))

- rust: bump ed25519-dalek from 1.0.0 to 1.0.1
  ([#3299](https://github.com/Orphiqprotocol/Orphiq-core/issues/3299))
...
- go/staking: Remove WatchTransfers/Burns/Escrows in favor of WatchEvents
  ([#3080](https://github.com/Orphiqprotocol/Orphiq-core/issues/3080))
...
- go/roothash: Drop support for multiple committees
  ([#3179](https://github.com/Orphiqprotocol/Orphiq-core/issues/3179))
...
- go/worker/executor: Support multiple transaction schedulers
  ([#3184](https://github.com/Orphiqprotocol/Orphiq-core/issues/3184))
  ...
  - `Orphiq_worker_txnscheduler_incoming_queue_size` ->
  `Orphiq_worker_incoming_queue_size`
...
- go/consensus/tendermint: Bump Tendermint Core to v0.34-rc4-Orphiq2
  ([#3186](https://github.com/Orphiqprotocol/Orphiq-core/issues/3186),
   [#3229](https://github.com/Orphiqprotocol/Orphiq-core/issues/3229))

- go/roothash: Add support for executor triggered timeouts
  ([#3199](https://github.com/Orphiqprotocol/Orphiq-core/issues/3199))
...
- go/common/cbor: Bump fxamacker/cbor to bafca87fa6db
  ([#3204](https://github.com/Orphiqprotocol/Orphiq-core/issues/3204))
...
- go/roothash: Change runtime round timeout to be in blocks
  ([#3210](https://github.com/Orphiqprotocol/Orphiq-core/issues/3210))
...
- go/common/crypto/signature: Remove `SignerRole.FromString()` method
  ([#3225](https://github.com/Orphiqprotocol/Orphiq-core/issues/3225))
...
- release: Wrap files in the release tarball in a single directory
  ([#3232](https://github.com/Orphiqprotocol/Orphiq-core/issues/3232))
...
- Bump protocol versions to 1.0.0 in preparation for the Mainnet
  ([#3249](https://github.com/Orphiqprotocol/Orphiq-core/issues/3249))
  ...
  an Orphiq Core release for the Mainnet, which signifies they are ready for
  production use.
...
- go/runtime/scheduling: Rename "batching" algorithm to "simple"
  ...
  The following `Orphiq-node registry runtime` command line flags have been
  renamed:
...
- go/consensus/api/transaction: Pretty-print transaction's fee amount in tokens
  ([#3151](https://github.com/Orphiqprotocol/Orphiq-core/issues/3151))

- go/consensus/api/transaction: Implement `PrettyPrinter` interface for `Fee`
  ([#3167](https://github.com/Orphiqprotocol/Orphiq-core/issues/3167))
...
- go/consensus: Add the `GetUnconfirmedTransactions` method
  ([#3187](https://github.com/Orphiqprotocol/Orphiq-core/issues/3187))
...
- go/consensus: Add `ErrDuplicateTx` error for duplicate transactions
  ([#3192](https://github.com/Orphiqprotocol/Orphiq-core/issues/3192))
...
- release: Add `Orphiq-remote-signer` binary to the release tarball
  ([#3226](https://github.com/Orphiqprotocol/Orphiq-core/issues/3226))

- go: Unify CLI tools' version display and also display the Go toolchain version
  ([#3233](https://github.com/Orphiqprotocol/Orphiq-core/issues/3233))

- go/Orphiq-node/cmd/common: Add `SetBasicVersionTemplate()` function
  ([#3233](https://github.com/Orphiqprotocol/Orphiq-core/issues/3233))

  It can be used to set a basic custom version template for the given cobra
  command that shows the version of Orphiq Core and the Go toolchain.

- go/control: Add per-runtime status report
  ([#3234](https://github.com/Orphiqprotocol/Orphiq-core/issues/3234))
...
- go/common/crypto/drbg: Also consider empty slices as Null values
  ([#3165](https://github.com/Orphiqprotocol/Orphiq-core/issues/3165))
  ...
  Orphiq code never uses HMAC_DRNG with a non-nil empty `additional_data`
  parameter, so nothing changes for Orphiq users.

- go/consensus/tendermint: Sync state database before discarding versions
  ([#3173](https://github.com/Orphiqprotocol/Orphiq-core/issues/3173))
...
- go/genesis: Remove time sanity check
  ([#3178](https://github.com/Orphiqprotocol/Orphiq-core/issues/3178))
...
- runtime: Use separate cache for checking transactions
  ([#3191](https://github.com/Orphiqprotocol/Orphiq-core/issues/3191))
...
- Executor should refresh runtime scheduling parameters
  ([#3203](https://github.com/Orphiqprotocol/Orphiq-core/issues/3203))
...
- go/roothash: Make the parent block check earlier
  ([#3206](https://github.com/Orphiqprotocol/Orphiq-core/issues/3206))

- go/registry: Correctly propagate lookup errors
  ([#3209](https://github.com/Orphiqprotocol/Orphiq-core/issues/3209))

- go/Orphiq-node: Omit existing entity check for non-file signers
  ([#3215](https://github.com/Orphiqprotocol/Orphiq-core/issues/3215))
...
- go: Fix CLI tools to not print error messages twice
  ([#3230](https://github.com/Orphiqprotocol/Orphiq-core/issues/3230))

- go/runtime/transaction: Ensure consistent batch order indices
  ([#3248](https://github.com/Orphiqprotocol/Orphiq-core/issues/3248))

- go/worker/storage: Always use fresh nodes for policy updates
  ([#3252](https://github.com/Orphiqprotocol/Orphiq-core/issues/3252))

- go/worker/common: Use group-synced storage client
  ([#3253](https://github.com/Orphiqprotocol/Orphiq-core/issues/3253))
...
- Add documentation example on the process of registering and running a runtime
  ([#3081](https://github.com/Orphiqprotocol/Orphiq-core/issues/3081),
   [#3207](https://github.com/Orphiqprotocol/Orphiq-core/issues/3207),
   [#3228](https://github.com/Orphiqprotocol/Orphiq-core/issues/3228))

- Expand documentation on test vectors
  ([#3205](https://github.com/Orphiqprotocol/Orphiq-core/issues/3205))

- Fix staking account address derivation description to match what the code does
  ([#3240](https://github.com/Orphiqprotocol/Orphiq-core/issues/3240))

- ADR 0002: Go Modules Compatible Git Tags
  ([#3242](https://github.com/Orphiqprotocol/Orphiq-core/issues/3242))

  Go Modules only allow [Semantic Versioning 2.0.0] for
  [versioning of the modules][go-mod-ver] which makes it hard to work
  with [Orphiq Core's CalVer (calendar versioning) scheme].

  Design a scheme for tagging Orphiq Core releases with Go Modules compatible Git
  ...
  [Orphiq Core's CalVer (calendar versioning) scheme]:
    docs/versioning.md

### Internal Changes

- go/storage/mkvs: Add NoPersist commit option
  ([#2186](https://github.com/Orphiqprotocol/Orphiq-core/issues/2186))
...
- go/Orphiq-test-runner: Add support for funding entities in genesis
  ([#3081](https://github.com/Orphiqprotocol/Orphiq-core/issues/3081))

  Additionally, make the default fixture command a bit more configurable.

- go/worker/storage: Add initial sync from checkpoints
  ([#3181](https://github.com/Orphiqprotocol/Orphiq-core/issues/3181))
...
- Update Badger version to v2.2007.2
  ([#3182](https://github.com/Orphiqprotocol/Orphiq-core/issues/3182),
   [#3227](https://github.com/Orphiqprotocol/Orphiq-core/issues/3227))

- go/Orphiq-test-runner: Fix e2e/consensus-state-sync scenario
  ([#3194](https://github.com/Orphiqprotocol/Orphiq-core/issues/3194))
...
- Bump Go to 1.15.1
  ([#3197](https://github.com/Orphiqprotocol/Orphiq-core/issues/3197))
...
- go/roothash/tester: Fix flaky `RoundTimeoutWithEpochTransition`
  ([#3214](https://github.com/Orphiqprotocol/Orphiq-core/issues/3214))

- ci: run the daily test for 12 hours
  ([#3219](https://github.com/Orphiqprotocol/Orphiq-core/issues/3219))

- Bump Rust toolchain to nightly-2020-08-29 for LVI mitigation speedups
  ([#3231](https://github.com/Orphiqprotocol/Orphiq-core/issues/3231))

- go: Bump bleve to 1.0.10
  ([#3231](https://github.com/Orphiqprotocol/Orphiq-core/issues/3231))

- Update Go dependencies
  ([#3238](https://github.com/Orphiqprotocol/Orphiq-core/issues/3238),
   [#3255](https://github.com/Orphiqprotocol/Orphiq-core/issues/3255))
...
- Configure [dependabot](https://dependabot.com/)
  ([#3239](https://github.com/Orphiqprotocol/Orphiq-core/issues/3239))
...
- Make: Augment `tag-next-release` to create a Go Modules compatible Git tag
  ([#3258](https://github.com/Orphiqprotocol/Orphiq-core/issues/3258))
...
- Introduce [Architectural Decision Records]
  ([#2924](https://github.com/Orphiqprotocol/Orphiq-core/issues/2924))

  [Architectural Decision Records]:
    https://github.com/Orphiqprotocol/adrs/blob/main/README.md

- Remind to bump protocol versions before release
  ([#3097](https://github.com/Orphiqprotocol/Orphiq-core/issues/3097))

### Removals and Breaking Changes

- go/registry: Add MinWriteReplication to runtime storage parameters
  ([#1821](https://github.com/Orphiqprotocol/Orphiq-core/issues/1821))
...
- go/common/cbor: Reject CBOR blobs with unknown fields
  ([#2020](https://github.com/Orphiqprotocol/Orphiq-core/issues/2020))

- go/consensus: Enable periodic state checkpoints
  ([#2880](https://github.com/Orphiqprotocol/Orphiq-core/issues/2880))
...
- go/consensus/tendermint: Bump Tendermint Core to 0.34
  ([#2882](https://github.com/Orphiqprotocol/Orphiq-core/issues/2882))

- go/worker/common/p2p: Use libp2p's gossipsub
  ([#3010](https://github.com/Orphiqprotocol/Orphiq-core/issues/3010))

- go/registry: Add up node thresholds for each runtime
  ([#3027](https://github.com/Orphiqprotocol/Orphiq-core/issues/3027))

- go/registry: Make TLS address required for RoleConsensusRPC
  ([#3038](https://github.com/Orphiqprotocol/Orphiq-core/issues/3038))

- go/consensus/tendermint: Fix node update verification
  ([#3040](https://github.com/Orphiqprotocol/Orphiq-core/issues/3040))

- runtime: Cleanup some runtime host protocol messages
  ([#3055](https://github.com/Orphiqprotocol/Orphiq-core/issues/3055))

- go: Rename existing staking token to base unit
  ([#3061](https://github.com/Orphiqprotocol/Orphiq-core/issues/3061))
...
- go/staking: Increase reward amount denominator
  ([#3065](https://github.com/Orphiqprotocol/Orphiq-core/issues/3065))
...
- go/registry/api: Remove `GetNodeList` method
  ([#3067](https://github.com/Orphiqprotocol/Orphiq-core/issues/3067))
...
- go/roothash/api: Include RuntimeID field in roothash events
  ([#3073](https://github.com/Orphiqprotocol/Orphiq-core/issues/3073))
...
- go/backends: Return pointers in GetEvents methods
  ([#3092](https://github.com/Orphiqprotocol/Orphiq-core/issues/3092))
...
- go/consensus/tendermint: Use P2P key for Tendermint P2P
  ([#3101](https://github.com/Orphiqprotocol/Orphiq-core/issues/3101))
...
- go/Orphiq-test-runner/env: Rename types, fields, functions to refer to scenario
  ([#3108](https://github.com/Orphiqprotocol/Orphiq-core/issues/3108))
...
- go/Orphiq-test-runner/cmd: Rename `--test` flag to `--scenario` flag
  ([#3108](https://github.com/Orphiqprotocol/Orphiq-core/issues/3108))

  Rename the short version from `-t` to `-s`.

- go/Orphiq-node/cmd/common/metrics: Rename "scenario" metrics label to "test"
  ([#3108](https://github.com/Orphiqprotocol/Orphiq-core/issues/3108))

- go/common/prettyprint: Augment `PrettyPrinter.PrettyPrint()` with `Context`
  ([#3111](https://github.com/Orphiqprotocol/Orphiq-core/issues/3111))

- go/Orphiq-node/cmd: Remove `--retry` flag from staking CLI commands
  ([#3113](https://github.com/Orphiqprotocol/Orphiq-core/issues/3113))

  Remove obsolete `--retry` flag from `Orphiq-node stake info`,
  `Orphiq-node stake list` and `Orphiq-node stake account info` CLI commands.

- go: Remove the integrated ledger support
  ([#3128](https://github.com/Orphiqprotocol/Orphiq-core/issues/3128))

  The signer and associated enumeration tool have been moved to
  Orphiqprotocol/Orphiq-core-ledger.

- go/Orphiq-node/cmd/common/consensus: Add `context.Context` to `SignAndSaveTx()`
  ([#3137](https://github.com/Orphiqprotocol/Orphiq-core/issues/3137))

- go/registry: Require SGX for non-test keymanager runtimes
  ([#3146](https://github.com/Orphiqprotocol/Orphiq-core/issues/3146))
...
- go/registry: Require SGX for non-test compute runtimes using a key manager
  ([#3159](https://github.com/Orphiqprotocol/Orphiq-core/issues/3159))
...
- go/consensus/tendermint: Make configuration options consistent
  ([#3082](https://github.com/Orphiqprotocol/Orphiq-core/issues/3082))
...
- Change the way seed-only nodes are configured
  ([#3116](https://github.com/Orphiqprotocol/Orphiq-core/issues/3116))
...
- registry: Allow nodes to opt-in to more runtimes
  ([#2179](https://github.com/Orphiqprotocol/Orphiq-core/issues/2179))
...
- e2e/tests: Added runtime upgrade test
  ([#2520](https://github.com/Orphiqprotocol/Orphiq-core/issues/2520))

- go Orphiq-node: Add CLI command for estimating gas cost of a transaction
  ([#2723](https://github.com/Orphiqprotocol/Orphiq-core/issues/2723))

  This adds `Orphiq-node consensus estimate_gas`.

  This adds `--transaction.unsigned`.

- go/Orphiq-node/cmd: Show Genesis document's hash when displaying transactions
  ([#2871](https://github.com/Orphiqprotocol/Orphiq-core/issues/2871))

  Show Genesis document's hash when generating staking transactions with
  `Orphiq-node stake account gen_*` CLI commands and when showing transactions'
  pretty prints with the `Orphiq-node consensus show_tx` CLI command.

- go/consensus/tendermint: Add support for state sync
  ([#2880](https://github.com/Orphiqprotocol/Orphiq-core/issues/2880))

- go/registry/api: Add `GetNodeByConsensusAddress` method
  ([#2961](https://github.com/Orphiqprotocol/Orphiq-core/issues/2961))

  `GetNodeByConsensusAddress` can be used to query nodes by their Consensus
  address.

- go/identity/cli: Add show TLS pubkey commands
  ([#3015](https://github.com/Orphiqprotocol/Orphiq-core/issues/3015))

  Adds following CLI helpers for displaying TLS public keys:

  - `Orphiq-node identity show-tls-pubkey --datadir <datadir>` for displaying
  the public key used in the external node gRPC endpoints.
  - `Orphiq-node identity show-sentry-client-pubkey --datadir <datadir>` for
  displaying the public key used by the upstream nodes when connecting to the
  sentry control endpoint.

- go/Orphiq-node/cmd/stake: Support showing stake amounts in tokens
  ([#3037](https://github.com/Orphiqprotocol/Orphiq-core/issues/3037))

  The `Orphiq-node stake info` and `Orphiq-node stake account info` CLI commands
...
- go/consensus/api: Add `GetTransactionsWithResults` method
  ([#3047](https://github.com/Orphiqprotocol/Orphiq-core/issues/3047))
...
- go/common/crypto/signature/signers/ledger: Descriptive error on user reject
  ([#3050](https://github.com/Orphiqprotocol/Orphiq-core/issues/3050))
...
- go/common/crypto/signature/signers/ledger: Add support for consensus signer
  ([#3056](https://github.com/Orphiqprotocol/Orphiq-core/issues/3056))

  Add support for consensus signer that can be used with the Orphiq Validator
  Ledger app.

- go/Orphiq-node/cmd/genesis: Allow setting staking token symbol and value exp
  ([#3061](https://github.com/Orphiqprotocol/Orphiq-core/issues/3061))

  Allow setting staking token's ticker symbol and token value's base-10 exponent
  in `Orphiq-node genesis init` CLI command via `--staking.token_symbol` and
...
- go/control: List all valid TLS public keys in identity status
  ([#3062](https://github.com/Orphiqprotocol/Orphiq-core/issues/3062))
...
- go/Orphiq-node: CLI support for the GetStatus endpoint
  ([#3064](https://github.com/Orphiqprotocol/Orphiq-core/issues/3064))

  See [docs/Orphiq-node/cli.md#status](/docs/Orphiq-node/cli.md#status).

- go/consensus: Expose read-only state via light client interface
  ([#3077](https://github.com/Orphiqprotocol/Orphiq-core/issues/3077))
...
- go/Orphiq-node/cmd/stake: Show pretty-printed account info
  ([#3087](https://github.com/Orphiqprotocol/Orphiq-core/issues/3087))

  Change `Orphiq-node stake account info` CLI command to output pretty-printed
  account info instead of raw JSON data.

- go/staking/api: Implement `PrettyPrinter` interface for various types
  ([#3087](https://github.com/Orphiqprotocol/Orphiq-core/issues/3087),
   [#3132](https://github.com/Orphiqprotocol/Orphiq-core/issues/3132))
...
- go/worker/storage: Added round sync metrics
  ([#3088](https://github.com/Orphiqprotocol/Orphiq-core/issues/3088))

- go/registry: Add support for querying suspended runtimes
  ([#3093](https://github.com/Orphiqprotocol/Orphiq-core/issues/3093))
...
- go/common/crypto/signature: Add a plugin backed signer implementation
  ([#3120](https://github.com/Orphiqprotocol/Orphiq-core/issues/3120))
...
- go/common/grpc: Client verbose logging and metrics
  ([#3121](https://github.com/Orphiqprotocol/Orphiq-core/issues/3121))
  ...
  - `Orphiq_grpc_calls` -> `Orphiq_grpc_server_calls`
  - `Orphiq_grpc_latency` -> `Orphiq_grpc_server_latency`
  - `Orphiq_grpc_stream_writes` -> `Orphiq_grpc_server_stream_writes`

  Added corresponding metrics:

  - `Orphiq_grpc_client_calls` gRPC client calls metric.
  - `Orphiq_grpc_client_latency` gRPC client call latencies.
  - `Orphiq_grpc_client_stream_writes` gRPC client stream writes.

- go/common/prettyprint: Add `QuantityFrac()`
  ([#3129](https://github.com/Orphiqprotocol/Orphiq-core/issues/3129),
   [#3131](https://github.com/Orphiqprotocol/Orphiq-core/issues/3131))

- go/Orphiq-node/cmd/common/consensus: Ask for confirmation before signing
  ([#3134](https://github.com/Orphiqprotocol/Orphiq-core/issues/3134))

  If file signer is used, ask for confirmation before signing a transaction,
  unless `--assume_yes` flag is set.

- go/Orphiq-node/cmd/common/consensus: Pretty print transaction before signing it
  ([#3134](https://github.com/Orphiqprotocol/Orphiq-core/issues/3134))

  Adapt `Orphiq-node stake account gen_*` CLI commands to display stake amount in
  pretty printed transactions in token values.

- go/Orphiq-node/cmd/common/flags: Add `--assume_yes` flag
  ([#3137](https://github.com/Orphiqprotocol/Orphiq-core/issues/3137))

- go/Orphiq-node/cmd/common: Add `GetUserConfirmation()`
  ([#3137](https://github.com/Orphiqprotocol/Orphiq-core/issues/3137))

- go/Orphiq-node/cmd/common/consensus: Print helper text about transaction review
  ([#3149](https://github.com/Orphiqprotocol/Orphiq-core/issues/3149))
...
- go/consensus: Add SubmitTxNoWait method
  ([#3152](https://github.com/Orphiqprotocol/Orphiq-core/issues/3152))
...
- go/consensus/api/transaction: Add `PrettyPrintBody()` to `Transaction` type
  ([#3157](https://github.com/Orphiqprotocol/Orphiq-core/issues/3157))

- go/worker/keymanager: Ignore runtimes not in policy document
  ([#3162](https://github.com/Orphiqprotocol/Orphiq-core/issues/3162))

- go/consensus: Move SubmitEvidence to LightClientBackend
  ([#3169](https://github.com/Orphiqprotocol/Orphiq-core/issues/3169))
...
- runtime: Reduce maximum RHP message size to 16 MiB
  ([#2213](https://github.com/Orphiqprotocol/Orphiq-core/issues/2213))

- go/worker/storage: Fix storage node policy
  ([#3021](https://github.com/Orphiqprotocol/Orphiq-core/issues/3021))

- runtime/dispatcher: Break recv loop on abort request
  ([#3023](https://github.com/Orphiqprotocol/Orphiq-core/issues/3023))

- go/runtime/host/sandbox: Fix possible data race
  ([#3024](https://github.com/Orphiqprotocol/Orphiq-core/issues/3024))
...
- go/consensus/tendermint: Properly handle no committed blocks
  ([#3032](https://github.com/Orphiqprotocol/Orphiq-core/issues/3032))

- runtime/committee/client: Reduce gRPC max backoff timeout
  ([#3035](https://github.com/Orphiqprotocol/Orphiq-core/issues/3035))
...
- go/worker/common/p2p: Don't treat context cancellation as permanent
  ([#3075](https://github.com/Orphiqprotocol/Orphiq-core/issues/3075))
...
- go/Orphiq-test-runner/cmd: Sort scenarios for correct parallel execution
  ([#3104](https://github.com/Orphiqprotocol/Orphiq-core/issues/3104))

- Orphiq-node/cmd/unsafe-reset: Fix globs for runtime files
  ([#3105](https://github.com/Orphiqprotocol/Orphiq-core/issues/3105))

- go/Orphiq-node/cmd/common: ExportEntity should use the entity ctor
  ([#3117](https://github.com/Orphiqprotocol/Orphiq-core/issues/3117))
...
- go/consensus/tendermint/roothash: Ignore non-tracked runtimes when reindexing
  ([#3124](https://github.com/Orphiqprotocol/Orphiq-core/issues/3124))

- go/tendermint/roothash: Skip pruned heights when reindexing
  ([#3127](https://github.com/Orphiqprotocol/Orphiq-core/issues/3127))

- go/worker/common: Treat stale unauthorized peer error as permanent
  ([#3133](https://github.com/Orphiqprotocol/Orphiq-core/issues/3133))
...
- go/worker/compute: Enforce maximum batch sizes from txn scheduler
  ([#3139](https://github.com/Orphiqprotocol/Orphiq-core/issues/3139))

- Bump libp2p to 0.10.2
  ([#3150](https://github.com/Orphiqprotocol/Orphiq-core/issues/3150))

- go/storage/mkvs/checkpoint: Remove empty version directories
  ([#3160](https://github.com/Orphiqprotocol/Orphiq-core/issues/3160))

  When all root checkpoints are removed for a specific version, the version dir
  itself should also be removed.

- go/registry/metrics: Fix `Orphiq_registry_runtimes` metric
  ([#3161](https://github.com/Orphiqprotocol/Orphiq-core/issues/3161))
...
- docs/runtime: Update the Runtime Host Protocol section
  ([#2978](https://github.com/Orphiqprotocol/Orphiq-core/issues/2978))

- docs: Add the [Accounts section] of the Staking docs
  ([#3005](https://github.com/Orphiqprotocol/Orphiq-core/issues/3005))

  [Accounts section]: docs/consensus/services/staking.md#accounts

- go/staking/api: Document commission-related public types
  ([#3042](https://github.com/Orphiqprotocol/Orphiq-core/issues/3042))

- Add [Governance Model](GOVERNANCE.md)
  ([#3130](https://github.com/Orphiqprotocol/Orphiq-core/issues/3130))

- ADR 0001: Multiple Roots Under the Tendermint Application Hash
  ([#3136](https://github.com/Orphiqprotocol/Orphiq-core/issues/3136))
...
- docs: Add cryptography section
  ([#3147](https://github.com/Orphiqprotocol/Orphiq-core/issues/3147))

### Internal Changes

- worker/sentry: Replace policy watcher with UpdatePolicies API method
  ([#2820](https://github.com/Orphiqprotocol/Orphiq-core/issues/2820))
...
- go/Orphiq-test-runner: Use common cli package for provisioning runtimes
  ([#3021](https://github.com/Orphiqprotocol/Orphiq-core/issues/3021))

- go/common/encoding/bech32: Replace to-be-removed dependency
  ([#3030](https://github.com/Orphiqprotocol/Orphiq-core/issues/3030))

- ci: Don't automatically retry timed out jobs
  ([#3036](https://github.com/Orphiqprotocol/Orphiq-core/issues/3036))

- go/Orphiq-test-runner: Refactor E2E scenarios
  ([#3043](https://github.com/Orphiqprotocol/Orphiq-core/issues/3043))
...
- go/Orphiq-test-runner/cmd/common: Give verbose error when scenario is not found
  ([#3044](https://github.com/Orphiqprotocol/Orphiq-core/issues/3044))

  List all available scenarios if `Orphiq-test-runner` command is invoked with an
  unknown scenario.

- go/worker/compute/executor: Defer fetching the batch from storage
  ([#3049](https://github.com/Orphiqprotocol/Orphiq-core/issues/3049))
...
- go/Orphiq-test-runner: Support regexps for matching scenario names
  ([#3051](https://github.com/Orphiqprotocol/Orphiq-core/issues/3051))

- go/common/cbor: Add support for generic versioned blobs
  ([#3052](https://github.com/Orphiqprotocol/Orphiq-core/issues/3052))

- go/registry: Add transaction test vector generator
  ([#3059](https://github.com/Orphiqprotocol/Orphiq-core/issues/3059))

- go/common/prettyprint: Add PrettyType for use in test vectors
  ([#3059](https://github.com/Orphiqprotocol/Orphiq-core/issues/3059))

- go/consensus/tendermint/epochtime_mock: Fix initial notify
  ([#3060](https://github.com/Orphiqprotocol/Orphiq-core/issues/3060))

- go/tests/sentry: Add access control sanity checks
  ([#3062](https://github.com/Orphiqprotocol/Orphiq-core/issues/3062))

- ci/longtests: Setup prometheus monitoring
  ([#3090](https://github.com/Orphiqprotocol/Orphiq-core/issues/3090))

- go/consensus/tendermint: Refactor internal event handling
  ([#3091](https://github.com/Orphiqprotocol/Orphiq-core/issues/3091))
...
- go: Use gofumpt instead of gofmt to format Go
  ([#3095](https://github.com/Orphiqprotocol/Orphiq-core/issues/3095))

- go/Orphiq-test-runner/cmd: Limit scenario name regex matching
  ([#3103](https://github.com/Orphiqprotocol/Orphiq-core/issues/3103))

  Prevent Orphiq-test-runner to match too many scenarios for a given
...
- go/tests/e2e: Add missing Clone() override to late-start
  ([#3106](https://github.com/Orphiqprotocol/Orphiq-core/issues/3106))

- go/Orphiq-test-runner: Refactor code to refer to scenario(s) consistently
  ([#3108](https://github.com/Orphiqprotocol/Orphiq-core/issues/3108))

- go/Orphiq-test-runner/Orphiq: Purge most of tests/fixture-data
  ([#3110](https://github.com/Orphiqprotocol/Orphiq-core/issues/3110))

- go/consensus/tendermint: Make New return consensus.Backend
  ([#3115](https://github.com/Orphiqprotocol/Orphiq-core/issues/3115))
...
- go: Use `cbor.Versioned` for descriptor versioning
  ([#3119](https://github.com/Orphiqprotocol/Orphiq-core/issues/3119))

- go/e2e/txsource: Periodically restart runtime nodes
  ([#3124](https://github.com/Orphiqprotocol/Orphiq-core/issues/3124))

- ci: Extract go artifacts upload code into a script
  ([#3125](https://github.com/Orphiqprotocol/Orphiq-core/issues/3125))

- go/tests/e2e/history_reindex: Scenario that triggers roothash reindexing
  ([#3127](https://github.com/Orphiqprotocol/Orphiq-core/issues/3127))

- go/badger: bump badger version
  ([#3142](https://github.com/Orphiqprotocol/Orphiq-core/issues/3142))

- go/Orphiq-node: Fix the interactive prompt to be correct
  ([#3143](https://github.com/Orphiqprotocol/Orphiq-core/issues/3143))
...
- release: Create a stable branch when preparing a new release
  ([#2993](https://github.com/Orphiqprotocol/Orphiq-core/issues/2993))
...
- Change staking account ids/addresses to truncated hash of the public key
  ([#2928](https://github.com/Orphiqprotocol/Orphiq-core/issues/2928))
  ...
  encoding for text serialization with `Orphiq` as their human readable part
  (HRP) prefix.

- go/common/crypto/signature: Rename `NewBlacklistedKey()` function
  ([#2940](https://github.com/Orphiqprotocol/Orphiq-core/issues/2940))
...
- Disallow v0 entity/node/runtime descriptors
  ([#2992](https://github.com/Orphiqprotocol/Orphiq-core/issues/2992))

- registry: Add runtime-specific staking thresholds
  ([#2995](https://github.com/Orphiqprotocol/Orphiq-core/issues/2995))

- go/staking: Rename fields in `Event` structure
  ([#3013](https://github.com/Orphiqprotocol/Orphiq-core/issues/3013))
...
- go/Orphiq-node/cmd/stake: Make `list` command's verbose output consistent
  ([#3016](https://github.com/Orphiqprotocol/Orphiq-core/issues/3016))

  Change `Orphiq-node stake list --verbose` CLI command's output to not list
...
- Change staking account ids/addresses to truncated hash of the public key
  ...
  - In `Orphiq-node staking account info` CLI, the `--stake.account.id`
    option has been renamed to `--stake.account.address` and now accepts a
    Bech32 encoded account address.
  - In `Orphiq-node staking account gen_transfer` CLI, the
    `--stake.transfer.destination` option now accepts a Bech32 encoded account
    address.
  - In `Orphiq-node staking account gen_escrow` and
    `Orphiq-node staking account gen_reclaim_escrow` CLI, the
...
- go/worker/sentry: Do client authentication on sentry control grpc
  ([#3018](https://github.com/Orphiqprotocol/Orphiq-core/issues/3018))
...
- go/worker/common: Allow specifying the path to the bwrap binary
  ([#1599](https://github.com/Orphiqprotocol/Orphiq-core/issues/1599))
...
- worker/compute/executor: Independently submit commit in case of faults
  ([#1807](https://github.com/Orphiqprotocol/Orphiq-core/issues/1807))
...
- runtime: Handle runtime interruptions gracefully
  ([#2991](https://github.com/Orphiqprotocol/Orphiq-core/issues/2991))

- go/Orphiq-node/cmd/stake: Add `pubkey2address` commmand
  ([#3003](https://github.com/Orphiqprotocol/Orphiq-core/issues/3003))

  Add `Orphiq-node stake pubkey2address` CLI command for converting a public key
...
- staking: Don't emit zero-amount staking events
  ([#2983](https://github.com/Orphiqprotocol/Orphiq-core/issues/2983))
...
- Bump Rust toolchain to 2020-06-09 for LVI mitigations
  ([#2987](https://github.com/Orphiqprotocol/Orphiq-core/issues/2987))

- worker/compute: Retry local dispatch between workers
  ([#3000](https://github.com/Orphiqprotocol/Orphiq-core/issues/3000))
...
- go/txsource: fix queries workload earliest committee epoch
  ([#3001](https://github.com/Orphiqprotocol/Orphiq-core/issues/3001))

- go/Orphiq-node: Support non-file signers in registry node init
  ([#3011](https://github.com/Orphiqprotocol/Orphiq-core/issues/3011))

### Documentation Improvements

- docs: Refactor setup instructions, add single validator node setup
  ([#3006](https://github.com/Orphiqprotocol/Orphiq-core/issues/3006))

### Internal Changes

- client: Rename the rpc crate to enclave_rpc
  ([#2469](https://github.com/Orphiqprotocol/Orphiq-core/issues/2469))

- runtime: Rename the rpc crate to enclave_rpc
  ([#2469](https://github.com/Orphiqprotocol/Orphiq-core/issues/2469))

- rust: Remove the use of the `failure` crate
  ([#2755](https://github.com/Orphiqprotocol/Orphiq-core/issues/2755))
...
- Makefile: update docker-shell target
  ([#2985](https://github.com/Orphiqprotocol/Orphiq-core/issues/2985))

- test/e2e/sentry: don't set seed node for nodes running with sentries
  ([#2989](https://github.com/Orphiqprotocol/Orphiq-core/issues/2989))

- ci: Remove push path filters for dockerfile build action
  ([#2997](https://github.com/Orphiqprotocol/Orphiq-core/issues/2997))
...
- go/registry: Avoid storing full TLS certificates
  ([#2556](https://github.com/Orphiqprotocol/Orphiq-core/issues/2556))
  ...
  - In `Orphiq-node registry node` CLI, the `--node.committee_address` option
...
- Make `Orphiq_` Prometheus metrics help consistent
  ([#2602](https://github.com/Orphiqprotocol/Orphiq-core/issues/2602))

  Help messages for metrics starting with `Orphiq_` were revisited and made
...
- Refactor the runtime host APIs
  ([#2801](https://github.com/Orphiqprotocol/Orphiq-core/issues/2801))
...
- go/consensus/tendermint: Clean up indices in SetNode
  ([#2910](https://github.com/Orphiqprotocol/Orphiq-core/issues/2910))

- go/registry: Drop support for v0 node descriptor
  ([#2918](https://github.com/Orphiqprotocol/Orphiq-core/issues/2918))

### Configuration Changes

- go/Orphiq-node: Fix signer configuration via YAML
  ([#2949](https://github.com/Orphiqprotocol/Orphiq-core/issues/2949))
...
- go/runtime/host/sgx: Add support for SIGSTRUCTs
  ([#1707](https://github.com/Orphiqprotocol/Orphiq-core/issues/1707))
...
- Add metrics for inter-node communcation
  ([#1771](https://github.com/Orphiqprotocol/Orphiq-core/issues/1771))

  - New `module` label was added to `Orphiq_codec_size` metric which contains
    information of the caller. Currently `p2p` value denotes a peer-to-peer
    message among Orphiq nodes and `runtime-host` a message from/to enclave.
  - New `Orphiq_rhp_latency` summary metric for measuring Runtime Host
    communication latency was added.
  - New `Orphiq_rhp_successes` and `Orphiq_rhp_failures` counter metrics for
    counting number of successful and failed Runtime Host calls respectively
    were added.

- go/Orphiq-node/cmd/debug: Add the `dumpdb` command
  ([#2359](https://github.com/Orphiqprotocol/Orphiq-core/issues/2359))
...
- e2e/tests: added keymanager runtime upgrade test
  ([#2517](https://github.com/Orphiqprotocol/Orphiq-core/issues/2517))

- Version signed entity, node and runtime descriptors
  ([#2581](https://github.com/Orphiqprotocol/Orphiq-core/issues/2581))
...
- Add new consensus-related Prometheus metrics
  ([#2842](https://github.com/Orphiqprotocol/Orphiq-core/issues/2842))

  Four new metrics have been added:

  - `Orphiq_worker_epoch_number` is the current epoch number as seen by the
    worker.
  - `Orphiq_worker_node_registered` is a binary metric which denotes, if the
    node is registered.
  - `Orphiq_consensus_proposed_blocks` is the number of proposed Tendermint
    blocks by the node.
  - `Orphiq_consensus_signed_blocks` is the number of Tendermint blocks the node
    voted for.

- keymanager: Rename APIs referencing "contracts"
  ([#2844](https://github.com/Orphiqprotocol/Orphiq-core/issues/2844))
...
- Orphiq-net-runner: add support for running networks with non-mock IAS
  ([#2883](https://github.com/Orphiqprotocol/Orphiq-core/issues/2883))

- go/stats: New availability v3 formula
  ([#2896](https://github.com/Orphiqprotocol/Orphiq-core/issues/2896))

  Here's the implementation of the new availability score v3 for May.

- consensus: Add GetStatus method to API
  ([#2902](https://github.com/Orphiqprotocol/Orphiq-core/issues/2902))
...
- go/extra/stats: Give ties the same rank
  ([#2908](https://github.com/Orphiqprotocol/Orphiq-core/issues/2908))

  Previously records tied by availability score would get different
  ranks, which was wrong.

- go/Orphiq-node/cmd/common/metrics: Deprecate formal pushgateway support
  ([#2936](https://github.com/Orphiqprotocol/Orphiq-core/issues/2936))
...
- runtime/storage/mkvs: Add method for checking local key existence
  ([#2938](https://github.com/Orphiqprotocol/Orphiq-core/issues/2938))
...
- staking: Add WatchEvents
  ([#2944](https://github.com/Orphiqprotocol/Orphiq-core/issues/2944))
...
- go/consensus/genesis: Add a public key blacklist
  ([#2948](https://github.com/Orphiqprotocol/Orphiq-core/issues/2948))
...
- common/flags: Fix parsing of metrics.labels, if provided in config .yml
  ([#2905](https://github.com/Orphiqprotocol/Orphiq-core/issues/2905))
...
- staking: Emit events when disbursing fees and rewards
  ([#2909](https://github.com/Orphiqprotocol/Orphiq-core/issues/2909))
...
- runtime: Notify runtimes of its key manager policy updates
  ([#2919](https://github.com/Orphiqprotocol/Orphiq-core/issues/2919))
...
- go/consensus: Hash user-controlled storage key elements
  ([#2929](https://github.com/Orphiqprotocol/Orphiq-core/issues/2929))

- go/Orphiq-node/cmd/common/metrics: Re-create the pusher on failure
  ([#2936](https://github.com/Orphiqprotocol/Orphiq-core/issues/2936))
...
- go/Orphiq-node: Fix parsing of signer configuration
  ([#2950](https://github.com/Orphiqprotocol/Orphiq-core/issues/2950))

- go/Orphiq-node: Make sure the node only tries to stop once
  ([#2964](https://github.com/Orphiqprotocol/Orphiq-core/issues/2964))

  This could previously result in a panic during shutdown.

- go/Orphiq-node: Don't bypass Stop in newNode failure handler
  ([#2966](https://github.com/Orphiqprotocol/Orphiq-core/issues/2966))

- go/runtime/host/sandbox: Retry Call in case the runtime is not yet ready
  ([#2967](https://github.com/Orphiqprotocol/Orphiq-core/issues/2967))

- go/Orphiq-node: Properly handle shutdown during startup
  ([#2975](https://github.com/Orphiqprotocol/Orphiq-core/issues/2975))

- go/consensus/tendermint: Don't panic on context cancellation
  ([#2982](https://github.com/Orphiqprotocol/Orphiq-core/issues/2982))
...
- Document all Prometheus metrics produced by `Orphiq-node`
  ([#2602](https://github.com/Orphiqprotocol/Orphiq-core/issues/2602))
  ...
  [docs/Orphiq-node/metrics.md](../docs/Orphiq-node/metrics.md) Markdown file. To
...
- ci: Automatically rebuild development/CI Docker images
  ([#295](https://github.com/Orphiqprotocol/Orphiq-core/issues/295))

- go: Replace the use of `pkg/error` with `fmt`
  ([#2057](https://github.com/Orphiqprotocol/Orphiq-core/issues/2057))
...
- go/control: Add IsReady() and WaitReady() RPC methods
  ([#2130](https://github.com/Orphiqprotocol/Orphiq-core/issues/2130))
  ...
  In addition new `Orphiq-node debug control wait-ready`
...
- Orphiq-test-runner: Refactor initialization of scenario flags
  ([#2897](https://github.com/Orphiqprotocol/Orphiq-core/issues/2897))
...
- ci: automatically rety exit status 125 failures
  ([#2900](https://github.com/Orphiqprotocol/Orphiq-core/issues/2900))

- go/ias: update test vector to a v4 report
  ([#2901](https://github.com/Orphiqprotocol/Orphiq-core/issues/2901))

- go: Bump Go to 1.14.3
  ([#2913](https://github.com/Orphiqprotocol/Orphiq-core/issues/2913))

- go: update dependencies depending on `websocket@v1.4.0`
  ([#2927](https://github.com/Orphiqprotocol/Orphiq-core/issues/2927))
...
- changelog: Add a changelog fragment type for configuration changes
  ([#2952](https://github.com/Orphiqprotocol/Orphiq-core/issues/2952))

- runtime-loader: Bump Fortanix EDP crate versions
  ([#2955](https://github.com/Orphiqprotocol/Orphiq-core/issues/2955))
...
- go/worker/registration: Add SetAvailableWithCallback to RoleProvider
  ([#2957](https://github.com/Orphiqprotocol/Orphiq-core/issues/2957))
...
- Transfer Orphiq-core repository to Orphiqprotocol
  ([#2968](https://github.com/Orphiqprotocol/Orphiq-core/issues/2968))

- ci: don't retry jobs that timeout
  ([#2969](https://github.com/Orphiqprotocol/Orphiq-core/issues/2969))

- go: update dynlib dep
  ([#2974](https://github.com/Orphiqprotocol/Orphiq-core/issues/2974))
...
- go/consensus/tendermint: Use MKVS for storing application state
  ([#1898](https://github.com/Orphiqprotocol/Orphiq-core/issues/1898))

- `Orphiq-node`: Refactor `metrics` parameters
  ([#2687](https://github.com/Orphiqprotocol/Orphiq-core/issues/2687))
...
- go/consensus/tendermint: Store consensus parameters in ABCI state
  ([#2710](https://github.com/Orphiqprotocol/Orphiq-core/issues/2710))

- go: Bump tendermint to v0.33.3-Orphiq1
  ([#2834](https://github.com/Orphiqprotocol/Orphiq-core/issues/2834))
...
- keymanager-lib: Bind persisted state to the runtime ID
  ([#2843](https://github.com/Orphiqprotocol/Orphiq-core/issues/2843))
...
- `Orphiq-net-runner`: `--net.*` flags renamed to `--fixture.default.*`
  ([#2848](https://github.com/Orphiqprotocol/Orphiq-core/issues/2848))

  For example `--net.node.binary mynode/Orphiq-node` becomes
  `--fixture.default.node.binary mynode/Orphiq-node`.

- go/consensus: Stake weighted voting
  ([#2868](https://github.com/Orphiqprotocol/Orphiq-core/issues/2868))
...
- go/common/node: Add RoleConsensusRPC role bit
  ([#2881](https://github.com/Orphiqprotocol/Orphiq-core/issues/2881))

### Features

- go/worker/consensusrpc: Add public consensus RPC services worker
  ([#2440](https://github.com/Orphiqprotocol/Orphiq-core/issues/2440))
...
- `Orphiq-node`: Add benchmarking utilities
  ([#2687](https://github.com/Orphiqprotocol/Orphiq-core/issues/2687))
...
- Add `GetEvents` to backends
  ([#2778](https://github.com/Orphiqprotocol/Orphiq-core/issues/2778))
...
- go/Orphiq-test-runner/Orphiq: Add a keymanager replication test
  ([#2843](https://github.com/Orphiqprotocol/Orphiq-core/issues/2843))

- `Orphiq-net-runner`: Add support for fixtures in JSON file
  ([#2848](https://github.com/Orphiqprotocol/Orphiq-core/issues/2848))
...
- go/consensus/tendermint: Expose new config options added in Tendermint 0.33
  ([#2855](https://github.com/Orphiqprotocol/Orphiq-core/issues/2855))
...
- go/consensus/tendermint: Signal RetainHeight on Commit
  ([#2863](https://github.com/Orphiqprotocol/Orphiq-core/issues/2863))
...
- go/consensus/tendermint: sync-worker additionally check block timestamps
  ([#2873](https://github.com/Orphiqprotocol/Orphiq-core/issues/2873))
...
- go/consensus: Add GetGenesisDocument
  ([#2889](https://github.com/Orphiqprotocol/Orphiq-core/issues/2889))
...
- go: Extract and generalize registry's staking sanity checks
  ([#2748](https://github.com/Orphiqprotocol/Orphiq-core/issues/2748))

  Augment the checks to check if an entity has enough stake for all stake claims
  in the Genesis document to prevent panics at Orphiq-node start-up due to
  entities not having enough stake in the escrow to satisfy all their stake
  claims.

- go/Orphiq-node/cmd/ias: Fix WatchRuntimes retry
  ([#2832](https://github.com/Orphiqprotocol/Orphiq-core/issues/2832))
...
- go/common/crypto/mrae/deoxysii: Use SHA512/256 for the KDF
  ([#2853](https://github.com/Orphiqprotocol/Orphiq-core/issues/2853))
...
- go/extra/stats: fix & simplify node-entity mapping
  ([#2856](https://github.com/Orphiqprotocol/Orphiq-core/issues/2856))
...
- go/extra/stats: fix heights at which missing nodes should be queried
  ([#2858](https://github.com/Orphiqprotocol/Orphiq-core/issues/2858))
...
- client/rpc: Change session identifier on reset
  ([#2872](https://github.com/Orphiqprotocol/Orphiq-core/issues/2872))
...
- go/worker/storage: Correctly apply genesis storage state
  ([#2874](https://github.com/Orphiqprotocol/Orphiq-core/issues/2874))
...
- worker/registration: use WatchLatestEpoch when watching for registrations
  ([#2876](https://github.com/Orphiqprotocol/Orphiq-core/issues/2876))
...
- go/runtime/client: Actually store the created key manager client
  ([#2885](https://github.com/Orphiqprotocol/Orphiq-core/issues/2885))
...
- go/scheduler: Increase tokens per voting power
  ([#2892](https://github.com/Orphiqprotocol/Orphiq-core/issues/2892))
...
- Refactor documentation, add architecture overview
  ([#2791](https://github.com/Orphiqprotocol/Orphiq-core/issues/2791))

### Internal changes

- `Orphiq-test-runner`: Add benchmarking utilities
  ([#2687](https://github.com/Orphiqprotocol/Orphiq-core/issues/2687))

  - `Orphiq-test-runner` now accepts `--metrics.address` and `--metrics.interval`
    parameters which are forwarded to `Orphiq-node` workers.
  - `Orphiq-test-runner` now signals `Orphiq_up` metric to Prometheus when a test
  ...
  - Multiple parameter values can be provided in form
    `--<test_name>.<param>=<val1>,<val2>,...`. In this case, `Orphiq-test-runner`
  ...
  - Each scenario is run in a unique datadir per parameter set of form
    `Orphiq-test-runnerXXXXXX/<test_name>/<run_id>`.
  - Due to very long datadir for some e2e tests, custom internal gRPC socket
    names are provided to `Orphiq-node`.
  - If metrics are enabled, new labels are passed to Orphiq-nodes and pushed to
  ...
  - New `cmp` command for analyzing benchmark results has been added which
    ...
    `go/Orphiq-test-runner` folder.

- ci: New benchmarks pipeline has been added
  ([#2687](https://github.com/Orphiqprotocol/Orphiq-core/issues/2687))

  `benchmarks.pipeline.yml` runs all E2E tests and compares the benchmark
  results from the previous batch using the new `Orphiq-test-runner cmp` command.

- `Orphiq-node`: Add custom internal socket path flag (for E2E tests only!)
  ([#2687](https://github.com/Orphiqprotocol/Orphiq-core/issues/2687))

  `--debug.grpc.internal.socket_name` flag was added which forces `Orphiq-node`
  ...
  the maximum unix socket path length. `Orphiq-test-runner` now generates
  shorter socket names in `/tmp/Orphiq-test-runnerXXXXXX` directory and provides
  them to `Orphiq-node`. **Due to security risks never ever use this flag in
...
- go/staking/tests: Add escrow and delegations to debug genesis state
  ([#2767](https://github.com/Orphiqprotocol/Orphiq-core/issues/2767))
...
- go/runtime/committee: Don't close gRPC connections on connection refresh
  ([#2826](https://github.com/Orphiqprotocol/Orphiq-core/issues/2826))
...
- go: Refactor E2E coverage integration test wrapper
  ...
  things other than Orphiq-node.

- go/Orphiq-node: Move storage benchmark subcommand under debug
  ([#2832](https://github.com/Orphiqprotocol/Orphiq-core/issues/2832))

- keymanager-runtime: replace with test/simple-keymanager
  ([#2837](https://github.com/Orphiqprotocol/Orphiq-core/issues/2837))
...
- docker: remove docker image build pipelines and cleanup testing image
  ([#2838](https://github.com/Orphiqprotocol/Orphiq-core/issues/2838))

- go/Orphiq-test-runner: Generate a new random seed on each run
  ([#2849](https://github.com/Orphiqprotocol/Orphiq-core/issues/2849))

- go/storage/mkvs/checkpoint: Refactor restorer interface
  ([#2860](https://github.com/Orphiqprotocol/Orphiq-core/issues/2860))
...
- go/Orphiq-test-runner: Configure consensus state pruning
  ([#2866](https://github.com/Orphiqprotocol/Orphiq-core/issues/2866))

- go: Start using new protobuf module location
  ([#2867](https://github.com/Orphiqprotocol/Orphiq-core/issues/2867))
...
- go/common/crypto/hash: Add NewFrom and NewFromBytes functions
  ([#2890](https://github.com/Orphiqprotocol/Orphiq-core/issues/2890))

- ci: automatically retry jobs due to host agent failures
  ([#2894](https://github.com/Orphiqprotocol/Orphiq-core/issues/2894))

## 20.5 (2020-04-10)

### Process

- Include Orphiq-core-runtime-loader and Orphiq-net-runner in releases
  ([#2780](https://github.com/Orphiqprotocol/Orphiq-core/issues/2780))

### Removals and Breaking changes

- storage: Rename "round" to "version"
  ([#2734](https://github.com/Orphiqprotocol/Orphiq-core/issues/2734))
...
- go staking: Remove locked accounts
  ([#2753](https://github.com/Orphiqprotocol/Orphiq-core/issues/2753))

  We expect not to need this feature.

- go/consensus: Introduce gas cost based on tx size
  ([#2761](https://github.com/Orphiqprotocol/Orphiq-core/issues/2761))

- storage/mkvs: Only nil value should mean deletion
  ([#2775](https://github.com/Orphiqprotocol/Orphiq-core/issues/2775))
...
- go/staking: include LastBlockFees in genesis
  ([#2777](https://github.com/Orphiqprotocol/Orphiq-core/issues/2777))
...
- go/staking: Three-way fee split
  ([#2794](https://github.com/Orphiqprotocol/Orphiq-core/issues/2794))
  ...
  See
  [Orphiq-core#2794](https://github.com/Orphiqprotocol/Orphiq-core/pull/2794)
...
- node: Add automatic TLS certificate rotation support
  ([#2098](https://github.com/Orphiqprotocol/Orphiq-core/issues/2098))
...
- go/storage/mkvs: Use Badger to manage versions
  ([#2674](https://github.com/Orphiqprotocol/Orphiq-core/issues/2674))
...
- go/common/crypto/signature/signer/composite: Initial import
  ([#2684](https://github.com/Orphiqprotocol/Orphiq-core/issues/2684))
...
- e2e tests: Test debonding entries from genesis
  ([#2747](https://github.com/Orphiqprotocol/Orphiq-core/issues/2747))
...
- Add support for custom runtime dispatchers
  ([#2749](https://github.com/Orphiqprotocol/Orphiq-core/issues/2749))
...
- txsource: delegation workload
  ([#2752](https://github.com/Orphiqprotocol/Orphiq-core/issues/2752))

- txsource: add a runtime workload
  ([#2759](https://github.com/Orphiqprotocol/Orphiq-core/issues/2759))
...
- go/txsource: add a commission schedule amendments workload
  ([#2766](https://github.com/Orphiqprotocol/Orphiq-core/issues/2766))

  The added workload generated commission schedule amendment requests.

- go/staking: add LastBlockFees query method
  ([#2769](https://github.com/Orphiqprotocol/Orphiq-core/issues/2769))
...
- go/txsource/transfer: inlcude burn transactions in transfer workload
  ([#2773](https://github.com/Orphiqprotocol/Orphiq-core/issues/2773))

- go/Orphiq-node/cmd/debug/consim: Initial import
  ([#2784](https://github.com/Orphiqprotocol/Orphiq-core/issues/2784))
...
- go/runtime/client: expose GetGenesisBlock method in runtime client
  ([#2796](https://github.com/Orphiqprotocol/Orphiq-core/issues/2796))

### Bug Fixes

- staking/state: fix DelegationsFor queries
  ([#2756](https://github.com/Orphiqprotocol/Orphiq-core/issues/2756))
...
- staking/api/commission: fix possible panic in validation check
  ([#2763](https://github.com/Orphiqprotocol/Orphiq-core/issues/2763))
...
- go/storage/client: Refresh connections when retrying
  ([#2783](https://github.com/Orphiqprotocol/Orphiq-core/issues/2783))
...
- go/storage/client: Don't treat "no nodes" as a permanent error
  ([#2785](https://github.com/Orphiqprotocol/Orphiq-core/issues/2785))

- go/consensus/tendermint: Use our notion of latest height
  ([#2786](https://github.com/Orphiqprotocol/Orphiq-core/issues/2786))
...
- go/runtime/client: use history for GetBlock(latest)
  ([#2795](https://github.com/Orphiqprotocol/Orphiq-core/issues/2795))
...
- go/storage/mkvs: Use cbor.UnmarshalTrusted for internal metadata
  ([#2800](https://github.com/Orphiqprotocol/Orphiq-core/issues/2800))

- go/consensus: Shorten gas import
  ([#2802](https://github.com/Orphiqprotocol/Orphiq-core/issues/2802))

  Switch to more concise `FromUint64`.

- go/consensus/tendermint/apps/staking: Propagate error in initTotalSupply
  ([#2809](https://github.com/Orphiqprotocol/Orphiq-core/issues/2809))

- go/staking: Use uint16 for limits in CommissionScheduleRules
  ([#2810](https://github.com/Orphiqprotocol/Orphiq-core/issues/2810))

- go/txsource/queries: Wait for indexed blocks before GetBlockByHash
  ([#2814](https://github.com/Orphiqprotocol/Orphiq-core/issues/2814))

- go/worker/registration: Fix crash when failing to query sentry addresses
  ([#2825](https://github.com/Orphiqprotocol/Orphiq-core/issues/2825))

- go/consensus/tendermint: Bump Tendermint Core to 0.32.10
  ([#2833](https://github.com/Orphiqprotocol/Orphiq-core/issues/2833))

### Documentation improvements

- README: Update Rust-related installation instructions
  ([#2745](https://github.com/Orphiqprotocol/Orphiq-core/issues/2745))

### Internal changes

- Move storage/mkvs/urkel to just storage/mkvs
  ([#2657](https://github.com/Orphiqprotocol/Orphiq-core/issues/2657))
...
- runtime: Add hongfuzz fuzzing targets
  ([#2705](https://github.com/Orphiqprotocol/Orphiq-core/issues/2705))

- go/staking/api: Add more details to sanity check errors
  ([#2760](https://github.com/Orphiqprotocol/Orphiq-core/issues/2760))

- Make: Allow running Go unit tests and node tests independently
  ([#2776](https://github.com/Orphiqprotocol/Orphiq-core/issues/2776))
...
- txsource/queries: increase the odds of querying the latest height
  ([#2787](https://github.com/Orphiqprotocol/Orphiq-core/issues/2787))
...
- Orphiq-test-runner/txsource: increase number of validators
  ([#2815](https://github.com/Orphiqprotocol/Orphiq-core/issues/2815))
...
- Orphiq-test-runner/txsource: disable LogAssertNoTimeouts if restarts
  ([#2817](https://github.com/Orphiqprotocol/Orphiq-core/issues/2817))

- go/extra/stats: Update availability score formula
  ([#2819](https://github.com/Orphiqprotocol/Orphiq-core/issues/2819))
...
- Orphiq-test-runner/txsource: disable Merge Discrepancy checker
  ([#2821](https://github.com/Orphiqprotocol/Orphiq-core/issues/2821))
...
- go/runtime/committee: Introduce close delay when rotating connections
  ([#2822](https://github.com/Orphiqprotocol/Orphiq-core/issues/2822))
...
- tests/fixture/txsources: add initial balance for validator-3
  ([#2830](https://github.com/Orphiqprotocol/Orphiq-core/issues/2830))
...
- go/registry: Enable non-genesis runtime registrations by default
  ([#2406](https://github.com/Orphiqprotocol/Orphiq-core/issues/2406))

- Optionally require a deposit for registering a runtime
  ([#2638](https://github.com/Orphiqprotocol/Orphiq-core/issues/2638))

- go/staking: Add stateful stake accumulator
  ([#2642](https://github.com/Orphiqprotocol/Orphiq-core/issues/2642))
...
- go/staking: More reward for more signatures
  ([#2647](https://github.com/Orphiqprotocol/Orphiq-core/issues/2647))
...
- Send and check expected epoch number during transaction execution
  ([#2650](https://github.com/Orphiqprotocol/Orphiq-core/issues/2650))
...
- go/staking: Add per-account lockup
  ([#2672](https://github.com/Orphiqprotocol/Orphiq-core/issues/2672))
...
- Use `--stake.shares` flag when specifying shares to reclaim from an escrow
  ([#2690](https://github.com/Orphiqprotocol/Orphiq-core/issues/2690))

  Previously, the `Orphiq-node stake account gen_reclaim_escrow` subcommand
...
- Implement node upgrade mechanism
  ([#2607](https://github.com/Orphiqprotocol/Orphiq-core/issues/2607))
...
- go/common/crypto/signature/signers/remote: Add experimental remote signer
  ([#2686](https://github.com/Orphiqprotocol/Orphiq-core/issues/2686))
...
- go/extra/stats: Figure out how many blocks entities propose
  ([#2693](https://github.com/Orphiqprotocol/Orphiq-core/issues/2693))

  Cross reference which node proposed each block and report these
  per-entity as well.

- go/extra/stats: Availability ranking for next Quest phase
  ([#2699](https://github.com/Orphiqprotocol/Orphiq-core/issues/2699))
...
- go/Orphiq-node/txsource: Add registration workload
  ([#2718](https://github.com/Orphiqprotocol/Orphiq-core/issues/2718))

- go/Orphiq-node/txsource: Add parallel workload
  ([#2724](https://github.com/Orphiqprotocol/Orphiq-core/issues/2724))

- go/scheduler: Validators now returns validators by node ID
  ([#2739](https://github.com/Orphiqprotocol/Orphiq-core/issues/2739))
...
- go/staking: Add a `Delegations()` call, and expose it over gRPC
  ([#2740](https://github.com/Orphiqprotocol/Orphiq-core/issues/2740))
...
- go/Orphiq-node/txsource: Use a special account for funding accounts
  ([#2744](https://github.com/Orphiqprotocol/Orphiq-core/issues/2744))
...
- go/storage/client: Retry storage ops on specific errors
  ([#1865](https://github.com/Orphiqprotocol/Orphiq-core/issues/1865))

- go/tendermint: Unfatalize seed populating nodes from genesis
  ([#2554](https://github.com/Orphiqprotocol/Orphiq-core/issues/2554))
...
- go: Re-enable signature verification disabled for migration
  ([#2615](https://github.com/Orphiqprotocol/Orphiq-core/issues/2615))
...
- go: Don't scan the whole keyspace in badger's tendermint DB implementation
  ([#2664](https://github.com/Orphiqprotocol/Orphiq-core/issues/2664))

  When we run off the end of a range iteration.

- runtime: Bump ring to 0.16.11, snow to 0.6.2, Rust to 2020-02-16
  ([#2666](https://github.com/Orphiqprotocol/Orphiq-core/issues/2666))

- go/staking/api: Fix genesis sanity check for nonexisting accounts
  ([#2671](https://github.com/Orphiqprotocol/Orphiq-core/issues/2671))
...
- go/storage/mkvs: Fix iterator bug
  ([#2691](https://github.com/Orphiqprotocol/Orphiq-core/issues/2691))

- go/storage/mkvs: Fix bug in `key.Merge` operation with extra bytes
  ([#2698](https://github.com/Orphiqprotocol/Orphiq-core/issues/2698))

- go/storage/mkvs: Fix removal crash when key is too short
  ([#2698](https://github.com/Orphiqprotocol/Orphiq-core/issues/2698))

- go/storage/mkvs: Fix node unmarshallers
  ([#2703](https://github.com/Orphiqprotocol/Orphiq-core/issues/2703))

- go/storage/mkvs: Fix proof verifier
  ([#2703](https://github.com/Orphiqprotocol/Orphiq-core/issues/2703))

- go/consensus/tendermint: Properly cache consensus parameters
  ([#2708](https://github.com/Orphiqprotocol/Orphiq-core/issues/2708))

- go/badger: Enable truncate to recover from corrupted value log file
  ([#2732](https://github.com/Orphiqprotocol/Orphiq-core/issues/2732))

  Apparently badger is not at all resilient to crashes unless the truncate
  option is enabled.

- go/Orphiq-net-runner/fixtures: Increase scheduler max batch size to 16 MiB
  ([#2741](https://github.com/Orphiqprotocol/Orphiq-core/issues/2741))
...
- go/common/version: Allow omission of trailing numbers in `parSemVerStr()`
  ([#2742](https://github.com/Orphiqprotocol/Orphiq-core/issues/2742))
...
- github: Bump GoReleaser to 0.127.0 and switch back to upstream
  ([#2564](https://github.com/Orphiqprotocol/Orphiq-core/issues/2564))

- github: Add new steps to ci-lint workflow
  ([#2572](https://github.com/Orphiqprotocol/Orphiq-core/issues/2572),
   [#2692](https://github.com/Orphiqprotocol/Orphiq-core/issues/2692),
   [#2717](https://github.com/Orphiqprotocol/Orphiq-core/issues/2717))
...
- ci: Skip some steps for non-code changes
  ([#2573](https://github.com/Orphiqprotocol/Orphiq-core/issues/2573),
   [#2702](https://github.com/Orphiqprotocol/Orphiq-core/issues/2702))
...
- go/common/cbor: Bump fxamacker/cbor to v2.2
  ([#2635](https://github.com/Orphiqprotocol/Orphiq-core/issues/2635))

- go/storage/mkvs: Fuzz storage proof decoder
  ([#2637](https://github.com/Orphiqprotocol/Orphiq-core/issues/2637))

- ci: merge coverage files per job
  ([#2644](https://github.com/Orphiqprotocol/Orphiq-core/issues/2644))

- go/Orphiq-test-runner: Update multiple-runtimes E2E test
  ([#2650](https://github.com/Orphiqprotocol/Orphiq-core/issues/2650))
...
- go/storage: Refactor checkpointing interface
  ([#2659](https://github.com/Orphiqprotocol/Orphiq-core/issues/2659))
...
- changelog: Use Git commit message style for Change Log fragments
  ([#2662](https://github.com/Orphiqprotocol/Orphiq-core/issues/2662))
...
- Add sanity checks for stake accumulator state integrity
  ([#2665](https://github.com/Orphiqprotocol/Orphiq-core/issues/2665))

- go/consensus/tendermint: Don't use `UnsafeSigner`
  ([#2670](https://github.com/Orphiqprotocol/Orphiq-core/issues/2670))

- rust: Update ed25519-dalek and associated dependencies
  ([#2678](https://github.com/Orphiqprotocol/Orphiq-core/issues/2678))

  This change updates ed25519-dalek, rand and x25519-dalek.

- Bump minimum Go version to 1.13.8
  ([#2689](https://github.com/Orphiqprotocol/Orphiq-core/issues/2689))
...
- Make build-fuzz work again, test it on CI
  ([#2695](https://github.com/Orphiqprotocol/Orphiq-core/issues/2695))

- changelog: Reference multiple issues/pull requests for a single entry
  ([#2697](https://github.com/Orphiqprotocol/Orphiq-core/issues/2697))
...
- github: Don't trigger ci-reproducibility workflow for pull requests
  ([#2704](https://github.com/Orphiqprotocol/Orphiq-core/issues/2704))

- go/Orphiq-test-runner: Improve txsource E2E test
  ([#2709](https://github.com/Orphiqprotocol/Orphiq-core/issues/2709))
...
- go/consensus/tendermint: Expire txes when CheckTx is disabled
  ([#2720](https://github.com/Orphiqprotocol/Orphiq-core/issues/2720))
...
- runtime: Remove the non-webpki/snow related uses of ring
  ([#2733](https://github.com/Orphiqprotocol/Orphiq-core/issues/2733))
...
- Add gRPC Sentry Nodes support
  ([#1829](https://github.com/Orphiqprotocol/Orphiq-core/issues/1829))
...
- go/common/crypto/tls: Use ed25519 instead of P-256
  ([#2058](https://github.com/Orphiqprotocol/Orphiq-core/issues/2058))
...
- All marshalable enumerations in the code were checked and the default
  ...
  ([#2546](https://github.com/Orphiqprotocol/Orphiq-core/issues/2546))
...
- go/registry: Add `ConsensusParams.MaxNodeExpiration`
  ([#2580](https://github.com/Orphiqprotocol/Orphiq-core/issues/2580))
...
- go/common/crypto/signature: Use base64-encoded IDs/public keys
  ([#2588](https://github.com/Orphiqprotocol/Orphiq-core/issues/2588))
...
- go/registry: Disallow entity signed node registrations
  ([#2594](https://github.com/Orphiqprotocol/Orphiq-core/issues/2594))
...
- go/registry: Ensure that node descriptors are signed by all public keys
  ([#2599](https://github.com/Orphiqprotocol/Orphiq-core/issues/2599))
...
- Rewards and fees consensus parameters
  ([#2624](https://github.com/Orphiqprotocol/Orphiq-core/issues/2624))
...
- Special rewards for block proposer
  ([#2625](https://github.com/Orphiqprotocol/Orphiq-core/issues/2625))

  - a larger portion of the fees
  - an additional reward

- go/consensus/tendermint: mux offset block height consistently
  ([#2634](https://github.com/Orphiqprotocol/Orphiq-core/issues/2634))
...
- Tendermint P2P configuration parameters
  ([#2646](https://github.com/Orphiqprotocol/Orphiq-core/issues/2646))
...
- Add `Orphiq-node identity tendermint show-{node,consensus}-address` subcommands
  ([#2649](https://github.com/Orphiqprotocol/Orphiq-core/issues/2649))

  The `show-node-address` subcommmand returns node's public key converted to
  Tendermint's address format.
  It replaces the `Orphiq-node debug tendermint show-node-id` subcommand.
...
- Refresh node descriptors mid-epoch
  ([#1794](https://github.com/Orphiqprotocol/Orphiq-core/issues/1794))
...
- go/worker/storage: Add configurable limits for storage operations
  ([#1914](https://github.com/Orphiqprotocol/Orphiq-core/issues/1914))

- Flexible key manager policy signers
  ([#2444](https://github.com/Orphiqprotocol/Orphiq-core/issues/2444))
...
- Add `Orphiq-node registry node is-registered` subcommand
  ([#2508](https://github.com/Orphiqprotocol/Orphiq-core/issues/2508))

  It checks whether the node is registered.

- Runtime node admission policies
  ([#2513](https://github.com/Orphiqprotocol/Orphiq-core/issues/2513))
  ...
  [#2078](https://github.com/Orphiqprotocol/Orphiq-core/issues/2078)).

- go/keymanager: Support policy updates
  ([#2516](https://github.com/Orphiqprotocol/Orphiq-core/issues/2516))
...
- Tooling for runtimes' node admission policy
  ([#2563](https://github.com/Orphiqprotocol/Orphiq-core/issues/2563))
...
- Export signer public key to entity
  ([#2609](https://github.com/Orphiqprotocol/Orphiq-core/issues/2609))
...
- go/registry: Handle the old and busted node descriptor envelope
  ([#2614](https://github.com/Orphiqprotocol/Orphiq-core/issues/2614))
...
- go/Orphiq-node/cmd/debug/fixgenesis: Support migrating Node.Roles
  ([#2620](https://github.com/Orphiqprotocol/Orphiq-core/issues/2620))
...
- go/registry: deduplicate registry sanity checks and re-enable address checks
  ([#2428](https://github.com/Orphiqprotocol/Orphiq-core/issues/2428))
...
- Make Orphiq-node binaries made with GoReleaser via GitHub Actions reproducible
  again
  ([#2571](https://github.com/Orphiqprotocol/Orphiq-core/issues/2571))

  Add `-buildid=` back to `ldflags` to make builds reproducible again.

  As noted in
  [60641ce](https://github.com/Orphiqprotocol/Orphiq-core/commit/60641ce),
  ...
  https://github.com/Orphiqlabs/goreleaser/issues/1).

- go/worker/storage: Fix sync deadlock
  ([#2584](https://github.com/Orphiqprotocol/Orphiq-core/issues/2584))

- go/consensus/tendermint: Always accept own transactions
  ([#2586](https://github.com/Orphiqprotocol/Orphiq-core/issues/2586))
...
- go/registry: Allow expired registrations at genesis
  ([#2598](https://github.com/Orphiqprotocol/Orphiq-core/issues/2598))
...
- go/Orphiq-node/cmd/registry/runtime: Fix loading entities in registry runtime
  subcommands
  ([#2606](https://github.com/Orphiqprotocol/Orphiq-core/issues/2606))

- go/storage: Fix invalid memory access crash in Urkel tree
  ([#2611](https://github.com/Orphiqprotocol/Orphiq-core/issues/2611))

- go/consensus/tendermint/apps/staking: Fix epochtime overflow
  ([#2627](https://github.com/Orphiqprotocol/Orphiq-core/issues/2627))

- go/tendermint/keymanager: Error in Status() if keymanager doesn't exist
  ([#2628](https://github.com/Orphiqprotocol/Orphiq-core/issues/2628))

  This fixes panics in the key-manager client if keymanager for the specific
  runtime doesn't exist.

- go/Orphiq-node/cmd/stake: Make info subcommand tolerate invalid thresholds
  ([#2632](https://github.com/Orphiqprotocol/Orphiq-core/issues/2632))
...
- go/staking/api: Check if thresholds for all kinds are defined in genesis
  ([#2633](https://github.com/Orphiqprotocol/Orphiq-core/issues/2633))

- go/cmd/registry/runtime: Fix provisioning a runtime without keymanager
  ([#2639](https://github.com/Orphiqprotocol/Orphiq-core/issues/2639))

- registry/api/sanitycheck: Move genesis stateroot check into registration
  ([#2643](https://github.com/Orphiqprotocol/Orphiq-core/issues/2643))

  Runtime genesis check should only be done when registering, not during the
  sanity checks.

- Make `Orphiq control is-synced` subcommand more verbose
  ([#2649](https://github.com/Orphiqprotocol/Orphiq-core/issues/2649))

  Running `Orphiq-node control is-synced` will now print a message indicating
...
- go/consensus/tendermint/abci: Add mock ApplicationState
  ([#2629](https://github.com/Orphiqprotocol/Orphiq-core/issues/2629))
...
- go node: Unite compute, merge, and transaction scheduler roles
  ([#2107](https://github.com/Orphiqprotocol/Orphiq-core/issues/2107))
...
- Simplify tendermint sentry node setup.
  ([#2362](https://github.com/Orphiqprotocol/Orphiq-core/issues/2362))
...
- Charge gas for runtime transactions and suspend runtimes which do not pay
  ...
  ([#2504](https://github.com/Orphiqprotocol/Orphiq-core/issues/2504))
...
- go: Rename compute -> executor
  ([#2525](https://github.com/Orphiqprotocol/Orphiq-core/issues/2525))
...
- `RuntimeID` is not hard-coded in the enclave anymore
  ([#2529](https://github.com/Orphiqprotocol/Orphiq-core/issues/2529))
...
- Consensus simulation mode and fee estimator
  ([#2521](https://github.com/Orphiqprotocol/Orphiq-core/issues/2521))
...
- Optimize registry runtime lookups during node registration
  ([#2538](https://github.com/Orphiqprotocol/Orphiq-core/issues/2538))
...
- Don't allow duplicate P2P connections from the same IP by default
  ([#2558](https://github.com/Orphiqprotocol/Orphiq-core/issues/2558))

- go/extra/stats: handle nil-votes and non-registered nodes
  ([#2566](https://github.com/Orphiqprotocol/Orphiq-core/issues/2566))

- go/Orphiq-node: Include account ID in `stake list -v` subcommand
  ([#2567](https://github.com/Orphiqprotocol/Orphiq-core/issues/2567))

  Changes `stake list -v` subcommand to return a map of IDs to accounts.

- Use a newer version of the Orphiq-core tendermint fork
  ([#2569](https://github.com/Orphiqprotocol/Orphiq-core/issues/2569))
...
- Document versioning scheme used for Orphiq Core and its Protocols
  ([#2457](https://github.com/Orphiqprotocol/Orphiq-core/issues/2457))

  See [Versioning Scheme](./docs/versioning.md).

- Document Orphiq Core's release process
  ([#2565](https://github.com/Orphiqprotocol/Orphiq-core/issues/2565))
...
- go/worker/txnscheduler: Check transactions before queuing them
  ([#2502](https://github.com/Orphiqprotocol/Orphiq-core/issues/2502))
...
- go/runtime/client: Return empty sequences instead of nil
  ([#2542](https://github.com/Orphiqprotocol/Orphiq-core/issues/2542))
...
- Temporarily disable consensus address checks at genesis
  ([#2552](https://github.com/Orphiqprotocol/Orphiq-core/issues/2552))
...
- Use the new runtime ID allocation scheme
  ([#1693](https://github.com/Orphiqprotocol/Orphiq-core/issues/1693))
...
- Remove staking-related roothash messages
  ([#2377](https://github.com/Orphiqprotocol/Orphiq-core/issues/2377))
...
- Refactoring of roothash genesis block for runtime
  ([#2426](https://github.com/Orphiqprotocol/Orphiq-core/issues/2426))
...
- When registering a new runtime, require that the given key manager ID points
  ...
  ([#2459](https://github.com/Orphiqprotocol/Orphiq-core/issues/2459))

- Remove `Orphiq-node debug dummy` sub-commands
  ([#2492](https://github.com/Orphiqprotocol/Orphiq-core/issues/2492))
...
- Make storage per-runtime
  ([#2494](https://github.com/Orphiqprotocol/Orphiq-core/issues/2494))

  Previously there was a single storage backend used by `Orphiq-node` which
...
- Add `Orphiq-node debug storage export` sub-command
  ([#1845](https://github.com/Orphiqprotocol/Orphiq-core/issues/1845))

- Add fuzzing for consensus methods
  ([#2245](https://github.com/Orphiqprotocol/Orphiq-core/issues/2245))
  ...
  Orphiq-core's demultiplexing and method dispatch mechanisms.

- Add storage backend fuzzing
  ([#2246](https://github.com/Orphiqprotocol/Orphiq-core/issues/2246))

  Based on the work done for consensus fuzzing, support was added to run fuzzing
  jobs on the storage api backend.

- Add `Orphiq-node unsafe-reset` sub-command which resets the node back to a
  freshly provisioned state, preserving any key material if it exists
  ([#2435](https://github.com/Orphiqprotocol/Orphiq-core/issues/2435))

- Add txsource
  ([#2478](https://github.com/Orphiqprotocol/Orphiq-core/issues/2478))
...
- Add consensus block and transaction metadata accessors
  ([#2482](https://github.com/Orphiqprotocol/Orphiq-core/issues/2482))
...
- Undisable transfers for some senders
  ([#2498](https://github.com/Orphiqprotocol/Orphiq-core/issues/2498))
...
- Entity block signatures count tool
  ([#2500](https://github.com/Orphiqprotocol/Orphiq-core/issues/2500))
...
- Reduce Badger in-memory cache sizes
  ([#2484](https://github.com/Orphiqprotocol/Orphiq-core/issues/2484))
...
- Start using the new Versioning and Release process for Orphiq Core.
  ([#2419](https://github.com/Orphiqprotocol/Orphiq-core/issues/2419))

  Adopt a [CalVer](http://calver.org) (calendar versioning) scheme for Orphiq
  ...
  https://github.com/Orphiqprotocol/Orphiq-core/issues/2457).
